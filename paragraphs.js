const paragraphs = {
  1: `O sol se põe. Enquanto o crepúsculo se transforma em escuridão, você começa a subir a colina na
direção da ameaçadora forma que se desenha contra o céu noturno. A Cidadela fica a menos de uma
hora de escalada.
A uma certa distância de seus muros, você pára para descansar
- um erro, uma vez que, dessa
posição, ela parece um espectro medonho do qual não se pode escapar. Os cabelos no seu pescoço
se arrepiam enquanto você a observa.
Mas você se envergonha de seus medos. Com inflexível decisão, você marcha adiante na direção do
portão principal, onde você sabe que encontrará guardas à sua espera. Você considera suas opções.
Já pensou em se apresentar como um especialista em plantas medicinais que veio tratar de um
guarda com febre. Poderia também se dizer um comerciante ou artesão
- talvez um carpinteiro.
...
da porta levadiça.
Você ouve grunhidos abafados ao se aproximar, e vê duas criaturas de aparência absurda. Do lado
esquerdo está uma criatura horrível, com a cabeça de um cachorro e o corpo de um grande macaco,
flexionando seus braços fortíssimos. Do outro lado, encontra-se de fato o seu oposto, com a cabeça
de um macaco no corpo de um cachorro grande. Este último guarda se aproxima nas suas quatro
patas. Pára a alguns metros de distância diante de você, ergue-se sobre as patas traseiras e dirige a
palavra a você.
...
Vá para 20`, 
  2: `Um pouco adiante na passagem há uma porta do lado direito. Esta porta está coberta por estranhos
caracteres, em uma linguagem que você não compreende. Você tentará abrir a porta (vá para 142)
ou continuará seguindo a passagem (vá para 343)?`, 
  3: `O que você oferecerá a eles?
...
Vá para 236
Se você não puder oferecer nenhuma dessas coisas, poderá desembainhar a sua espada (vá para 286)
ou se dirigir para a porta mais distante (vá para 366).`, 
  4: `Você faz aparecer uma bola de fogo e a manda voando no rosto da criatura. Porém, fica assistindo
...
Cópia de Criatura (vá para 190), ou desembainhar a sua espada (vá para 303).`, 
  5: `Você experimenta a maçaneta da porta e ela gira, abrindo para um outro corredor. Logo adiante, a
passagem vira para a direita e termina pouco depois em outra porta. Nesta porta há um letreiro que
diz "Por Favor Toque a Campainha para Chamar o Mordomo". Uma corda
- evidentemente a
...
experimenta a maçaneta da porta (vá para 361)?`, 
  6: `o caminho segue ao longo do rio por vários metros e depois volta a penetrar na rocha. Você segue o
...
você corra para a entrada principal da Cidadela. Vá para 218.`, 
  9: `Sob o seu Encanto da Ilusão, a multidão de espectadores olha você começar a jogar. Você observa
umas duas rodadas e a tensão cresce. Você resolve que é melhor sair do aposento sem mais perda de
tempo. Vá para 31.`, 
  10: `Você tateia pela rocha e acaba por encontrar uma pequena alavanca. Ao puxar esta alavanca, a face
...
investigar. Vá para 249.`, 
  11: `Você conseguiu desviar os olhos da criatura e agora recua para o canto, protegendo o rosto com o
...
mochila e segurá-lo na direção do feiticeiro (vá para 347). Se não tiver, vá para 153.`, 
  12: `Ele fica parado diante de você, respirando pesadamente. O Encanto dele evidentemente foi bastante
...
espécie de cozinha
- pegando vários ingredientes dos armários e acrescentando-os a um caldo
...
começam a dar gargalhadas e gritos enquanto riem. Você deixará que elas acreditem que você é o
novo empregado que elas estão esperando (vá para 302) ou quer investigar o aposento com mais
vagar (vá para 215)?`, 
  14: `A sombra do muro dificulta muito a visão. Uma pedra solta desliza, e você perde o equilíbrio,
...
volta no poço e continuar (vá para 79). Se você não tiver sorte, cai lá dentro (vá para 100).`, 
  15: `A adaga é realmente uma obra de arte e sem dúvida valia um bom preço. A lâmina é feita de metal
...
Vá para 245.`, 
  16: `Resolva esta batalha:
GARK
HABILIDADE 7
ENERGIA 11
Depois de quatro Séries de Ataques, você poderá Fugir por uma das portas na extremidade mais
distante do aposento (vá para 99). Se quiser continuar a batalha faça isso e vá para 180, se vencer.`, 
  17: `Todo tipo de alimentos estranhos podem ser encontrados nos armários. Globos oculares, línguas,
...
inquisitivo. Você pode procurar outro livro útil, que possa ajudá-lo na sua empreitada (vá para 84)
ou tentar sair da biblioteca pela porta atrás dele (vá para 31).`, 
  19: `A escada geme quando você põe o pé nela. Você tenta subir o mais silenciosamente possível, mas a
...
contrário, vá para 254.`, 
  20: `O Macaco-Cachorro diz que não é permitido a ninguém entrar na Torre Negra depois que anoitece -
você terá que procurar abrigo em outro lugar. Você pode se resignar a lutar (vá para 288). Ou pode
pegar uma pedra e lançar um Encanto do Ouro dos Tolos sobre ela, oferecendo-a como uma pepita
de ouro, para suborná-los, convencendo-os a deixar você entrar (vá para 96). Deduza o Encanto do
Ouro dos Tolos de seus Encantos, se você o usar.`, 
  21: `Você oferece a ele as pedrinhas que transformou em ouro. "Tudo o que eu quero está aqui
...
tentar outro Encanto. Você partirá para um Encanto de Percepção Extra-Sensorial (volte para 123)
ou um Encanto da Ilusão (volte para 35)? Se você não tiver nenhum deles, vá para 283.`, 
  22: `Você abre a porta e sai em um corredor longo e escuro. Vá para 188.`, 
  23: `Você abre a porta e sai em uma passagem que continua direto para frente por algum tempo. Vira
...
grande aposento. Você caminha na direção do aposento e entra nele. Vá para 169.`, 
  24: `"O que traz você a estas paragens?" ela pergunta. Você conta a ela sua história, evitando
...
SORTE pelas informações que obteve e siga adiante. Volte para o 6.`, 
  25: `A porta abre, dando para um aposento grande e circular. Você coça a cabeça, intrigado. No centro
...
Se você não possuir nenhum deles, retorne para 304 e Escolha de novo.`, 
  27: `Quando você mostra as Peças de Ouro, as três criaturas interrompem seu caminho. Eles engasgam
...
de sucesso dos Miks e sair pela porta à sua frente. Vá para 206.`, 
  28: `Você lança o Encanto e faz aparecer uma bola de fogo nas suas mãos. Eles interrompem seu
...
prosseguir pela passagem da esquerda (vá para 243) ou pela passagem da direita (volte para 2).`, 
  29: `Cautelosamente, você se aproxima do homenzinho. Ao chegar perto, um único olho se abre e olha
...
você. Ele parece suficientemente amigável - você aperta a mão dele e tenta fazer amizade (vá para
271) ou desembainha sua espada (vá para 131)?`, 
  30: `A fera é imensamente poderosa. Você desembainha a sua espada e a batalha começa:
FERA DAS GARRAS
HABILIDADE 9
ENERGIA 14
Depois que você tiver atingido a criatura pela quarta vez, vá para 241.`, 
  31: `Você sai do aposento pela porta do outro lado, a qual abre para uma passagem curta que termina em
uma grande porta de madeira. A maçaneta desta porta gira, deixando que você entre em uma grande
câmara. Vá para 169.`, 
  32: `Passando por sobre os corpos, você se aproxima do portão e chama o porteiro, para em seguida se
esconder na escuridão quando ele se aproxima. Ele vê os corpos e sai para investigar, e, enquanto
isso, você aproveita para esgueirar-se rapidamente pelo portão e trancá-lo do lado de fora. Vá para
Er
AD (==)
Pere?`, 
  33: `Quando você tenta se levantar, o Orca e o Goblin agarram você e o seguram no chão, enquanto o
Anão avança com sua clava. Vá para 213.`, 
  34: `A chave gira e, retirando a tranca, você abre a caixa, encontrando outra chave, dessa vez talhada em
...
sairá do aposento com as duas chaves (vá para 237)?`, 
  35: `Você se concentra na sua Ilusão. Você pode convencê-lo de que ele está sendo atacado por um
inimigo (vá para 364), ou fazer com que você desapareça, na esperança de que ele virá procurar por
você (vá para 246).`, 
  36: `"Bah!”, diz o Gark," não é tão fácil me enganar. Jogue fora estes pedaços de latão." A criatura tem a
...
ditas pelo Gark orgulhoso: "Para a cadeia com esse aqui!" Vá para 234. E não se esqueça de deduzir
o Encanto do Ouro dos Tolos desperdiçado.`, 
  37: `Você puxa a pele e a criatura solta silvos altos. Todas as suas cabeças recuam,e ela permanece
...
segue para a porta cautelosamente. Vá para 229.`, 
  38: `A porta abre para uma passagem curta, calçada com pedras pequenas. A uma pequena distância
...
para 132) ou resolverá desistir desse aposento e tomar a passagem que sai para a esquerda (vá para`, 
  39: `Você pega o Vidro e, ao fazer isso, os Ganjees ficam ofegantes. "Racknee!" diz uma voz. "Você
voltou!" E com estas palavras; uma mão invisível arranca o vidro das suas mãos, coloca-o no chão e
abre a tampa.
O Homem-Aranha volta-se na sua direção e solta um pequeno grunhido. Você
...
HABILIDADE 7
ENERGIA 5
Logo que o Homem-Aranha conseguir atingir você pela primeira vez, vá para 208. Se você vencer
...
ANS
PAIN`, 
  40: `Depois de vários minutos, a porta se abre lentamente, e uma criatura corcunda e deformada, com
...
bifurcação para a esquerda, a pouca distância dali. Você acreditará nele e tomará a bifurcação para a
esquerda (vá para 243) ou não confiará nesta criatura imprevisível e tomará a bifurcação da direita
(volte para 2)?`, 
  41: `As três mulheres se juntam, fazendo um círculo, e sussurram umas com as outras. Com um risinho,
...
está em outro aposento. Vá para 257.`, 
  42: `Ela pisca, e os jatos de fogo desaparecem. O que você oferecerá a ela?
Um Espelho de Prata?
Vá para 138
...
distante (vá para 304).`, 
  43: `Quando você lança o encanto, ele afrouxa o aperto. Gradualmente, sua força diminui, até que ele
...
prosseguir no seu caminho. Volte para 14.`, 
  44: `O aposento pára de sacudir e você cai no chão. O armário das armas está trancado, mas você pode
...
Vá para 277`, 
  45: `Se seu estômago aguentar, você poderá experimentar:
...
Um naco de pão
Vá para 97`, 
  46: `Com um gesto, você estica a mão para frente e aponta o chão sob os pés do feiticeiro. Fumaça e
...
Vá para 259
Se você não possuir nenhum desses encantos, terá que recuar na direção do monumento no centro
do pátio e se esconder dela (vá para 209).`, 
  48: `"Nunca!" grita o feiticeiro, voltando das sombras para enfrentar você. Dessa vez, é você quem sente
...
Você fugirá desta criatura (vá para 232) ou avançará com seu Tridente (vá para 199)?`, 
  49: `A criatura fica olhando fixamente para você com ar inquisitivo, como se estivesse insegura em
relação a você. Vá para 255.`, 
  51: `Você distribui loucamente golpes com sua espada, mas não consegue atingir a criatura. Ou ela é
...
puder lançar nenhum dos dois, irá para 280.`, 
  52: `A porta abre e você segue adiante, batendo-a para que se feche atrás de você. Pouca distância à
...
faltando. Você continua fingindo e junta-se a eles (vá para 385) ou dirá a eles que estão enganados e
tentará chegar até a porta do outro lado do aposento (vá para 227)?`, 
  53: `"Para que eu quero suas amoras?” ela ri. "Meu apetite morreu com meu corpo!" E, quando você
...
vindo na sua direção. Vá para 194.`, 
  54: `Você procura dentro de sua mochila. O que você pegará:
...
Se você não tiver nenhuma, dessas coisas, terá que retornar para 104 e escolher de novo.`, 
  55: `Você segue a passagem por algum tempo. Ela vira para a direita e acaba chegando a um beco sem
...
passagens secretas (volte para 10).`, 
  56: `O ELFO NEGRO que se aproxima de você é raquítico e maltrapilho. Ele pergunta se você é um
...
dE
E ANSA`, 
  57: `Teste a sua Sorte. Se você tiver sorte, vá para 150. Se não tiver, vá para 233.`, 
  58: `Quando você entra, os Gremlins esvoaçam e guincham excitados, depois voam, passando por você
...
Ou sairá e prosseguirá na direção da Cidadela (vá para 156)?`, 
  59: `Eles ficam revoltados com seu presente e correm para o canto do aposento, se escondendo embaixo
...
segue na direção da porta do outro lado do aposento. Vá para 140.`, 
  60: `As criaturas ficam desconfiadas quando você as pressiona, buscando informações. O Anão salta
...
Ou poderá puxar a sua espada e lutar (vá para 213).`, 
  61: `Você avança com sua espada. O Devlin pára... e salta sobre você!. Você golpeia com sua espada,
...
recuperação. Afinal, você será mesmo a próxima refeição das criaturas da Torre Negra...`, 
  62: `Com o Gárgula fora de combate, você decide investigar a caixa no pedestal da criatura. Teste a sua
Sorte. Se você tiver sorte, pode levar a bolsa com dez Peças de Ouro trancada lá dentro. Se não tiver
sorte, não consegue abrir a caixa. Saia do aposento e vá para 140.`, 
  63: `Você vai até o índice remissivo e verifica a referência. Ao chegar à página correta, você fica
...
HE
VA`, 
  64: `Você ouve junto à porta e consegue escutar vozes esganiçadas rindo e brigando. Você experimenta
...
Vá para 366`, 
  65: `Você se ajoelha diante dele e se curva. Ele é de fato o seu senhor agora. Você falhou na sua missão.`, 
  66: `Eles olham um para o outro e conversam. Um deles se adianta e estende a mão com um pequeno
...
a todos pela companhia, depois parte na direção das portas. Vá para 270.`, 
  67: `Você começa a sua luta contra a criatura. Seu primeiro golpe é certeiro e corta uma das seis
...
Encanto de Cópia de Criatura (vá para 143) ou alguma coisa de sua mochila (vá para 226)?`, 
  68: `“Por qual eu iria, hein?” ele considera. "Vamos ver... eu não iria por uma das duas portas à esquerda
...
Vá para 354`, 
  69: `A criatura não é de muita conversa, mas você consegue descobrir que está nas masmorras dos
...
melhor você tentar usar um Encanto para conseguir sair dessa prisão. Vá para 193.`, 
  70: `Você voa para cima e mantém-se longe dos botes dele, mas ele não sai do lugar onde está, e não há
...
arrancar o tentáculo de sua perna e prosseguir para a entrada principal da Torre Negra. Vá para 218.`, 
  72: `A sorte não está do seu lado. Seu primeiro olhar na direção da criatura com serpentes na cabeça foi
...
Balthus Dire. Você falhou na sua missão.`, 
  73: `Você pode tentar se livrar da Cobra de Esgoto, ou mantê-la a distância com um encanto. Se decidir
lutar contra a criatura, resolva esta batalha:
COBRA DE ESGOTO
HABILIDADE 6
ENERGIA 7
Se vencer, vá para 112.
Se quiser lançar um Feitiço da Força, acrescente três ao número obtido nos dados para sua Força de
Ataque. Se quiser lançar um Feitiço do Fogo, vá para 282`, 
  74: `Ao pular de lado, os olhos do feiticeiro seguem você — e a bola de fogo dele também. Ela atinge
você no peito, derrubando-o no chão. A queimadura custará 4 pontos de ENERGIA. Se você ainda
estiver vivo, poderá preparar outro Encanto para o seu contra-ataque. Vá para 377.`, 
  75: `Você cruza a soleira, fecha a porta atrás de você e espera algum tempo. Ouve as passadas se
...
PAQVTSN
NES`, 
  76: `Enquanto você estava tirando suas Amoras da mochila, Balthus Dire ficou se concentrando em um
...
para 191.`, 
  78: `Seus olhos seguem você até a janela. Suas pupilas tornaram-se brancas como o leite. Ele inclina sua
...
Vá para 277`, 
  79: `No canto mais distante do pátio, você encontra um arbusto diferente, com galhos contorcidos a
...
Cidadela. Vá para 218.`, 
  80: `Quando, você salta por cima da mesa, o feiticeiro gira em torno de si mesmo. Você tropeça e desaba
...
Você continua o seu ataque (vá para 199) ou foge dele (vá para 232)?`, 
  81: `O Macaco-Cachorro ri e diz a você que Kylltrog é um preguiçoso que não serve para nada, e que
...
deixar você entrar. Vá para 251.`, 
  82: `Você cai no fosso. Freneticamente, você tenta agarrar a borda ao cair, mas sem êxito. Você
...
solo lá embaixo, o que mata você instantaneamente. Você falhou na sua missão.`, 
  83: `O homem é um comerciante. Você diza ele que vocês são companheiros de profissão,
e vocês conversam por algum tempo sobre preços e lucros dentro da Torre Negra. Ele diz que nunca
...
são bastante desprezados lá dentro. Você se despede e segue adiante. Vá para 245.`, 
  84: `Ao examinar as prateleiras, você ouve urna grande movimentação atrás de você. Você se vira rapidamente,
a tempo de ver criaturas semelhantes a Orcas, armadas e em guarda, materializaram-se uma após
a outra diante de você. Elas avançam e cercam você. O mais alto chega o rosto perto do
...
chão, inconsciente. Vá para 234.`, 
  85: `Você lança seu Feitiço e espera que a bola de fogo apareça na ponta da sua tocha. A tocha se acende, apenas
o suficiente para que você veja que há uma porta do outro lado do aposento, mas depois se apaga de novo.
Os Ganjees riem mais uma vez dos seus esforços para enganá-los. Você sente uma pancada na cabeça que
volta a derrubá-lo no chão. Você perde dois pontos de ENERGIA. Você:
Tentará um Encanto da Ilusão? Vá para 395
Pegará alguma coisa na sua mochila? Vá para 322
Desembainhará a sua espada? Vá para 248`, 
  86: `Quando você lança o encanto, as duas criaturas ficam olhando espantadas enquanto você flutua no
ar, passa sobre suas cabeças na direção do portão, sobre a muralha e para o interior da Cidadela.
Você aterrissa do lado de dentro e olha à sua volta. Vá para 251.
Mas tome cuida do! Eles com certeza avisarão os guardas da Cidadela.
Risque o Encanto da Levitação que acabou de usar na sua Folha de Aventuras.`, 
  87: `Você cria urna grande bola de fogo nas suas mãos e a lança sobre a criatura. Não adianta nada.
Gárgula dá um soco em você, e o golpe joga você no chão. Desconte dois pontos de ENERGIA. E
melhor evitar esta fera, sair do aposento e tentar a porta do meio da sacada. Vá para 64.`, 
  88: `A porta é extremamente forte, mas cede mo pouco quando você a golpeia. Você pode tentar golpeá-
la tanto tempo quanto quiser, até que ela ceda de todo. Jogue um dado para cada tentativa. Se
obtiver um seis, você consegue (vá para 292). Para cada tentativa sem êxito, você perderá um ponto
de ENERGIA. Se você resolver não agir dessa maneira, poderá usar o Encanto da Força (vá para
170), tentar a porta do meio (vá para 64), ou a porta na outra extremidade da sacada (vá para 304).`, 
  89: `A chave gira, a fechadura se abre e você olha dentro da caixa.
Lá dentro há um vidro grande que contém uma aranha.
Mas não é uma aranha comum; esta criatura tem o rosto de um velho. Ele
está falando com você, mas você não consegue entender o que ele está dizendo. Um barulho chama a
...
SN:
“Zu`, 
  90: `A passagem se alarga, e você está agora andando ao longo de um rio que corre. Bem à frente, há
...
Vá para 329`, 
  91: `Ela olha para a sua oferta e seus olhos se arregalam. "Deixe-me ver isso, ela ordena. Você avança
...
sair pela outra porta (vá para 140). Se não tiver sorte, você pode Testar a sua Sorte de novo até que
...
você e sair de qualquer modo (vá para 140).`, 
  92: `O líquido leitoso cheira bem. Você toma um gole e começa a sorrir. Dá um gole maior e explode
...
reconfortante.`, 
  93: `Do lado de fora, você olha para sua garrafa. É uma garrafa de Essência de Erva de Porco,
...
Vá para 169.`, 
  94: `Você sente o seu próprio poder crescendo. Você corre na direção da porta e a golpeia firme como
ombro... mas ela nem se mexe! Você perde um ponto de ENERGIA pela contusão e bate com força
...
uma opção — pode ser descrito apenas como estando presente em um aposento). Você pode agora
...
que você usou para entrar (vá para 281).`, 
  98: `O GOLEM que avança na sua direção é uma criatura que se move com lentidão, e você alcança
facilmente as caixas. Enquanto você luta com as fechaduras,
o GOLEM chega até você. Você pode:
...
Vá para 237`, 
  99: `Você vai pela porta da esquerda (volte para 52) ou pela porta da direita (volte para 38)?`, 
  100: `Você tem um Encanto da Levitação? Se tiver, é melhor você usá-lo agora para flutuar para fora do
poço. Se você levitar, poderá continuar pela muralha na direção do canto do pátio (volte para 79).
Se não, vá para 276.`, 
  101: `Uma réplica da criatura se materializa entre vocês dois. A uma ordem sua, a batalha começa:
GÁRGULA
HABILIDADE 9
ENERGIA 10
...
enfrentar o Gárgula sozinho e sai do aposento, tentando a porta no meio da sacada. Volte para 64.`, 
  102: `Eles simpatizam com o seu pedido. Três deles voltam-se na direção do outro e, com óbvia
...
ajudar, por isso eu o dou a você." Você lhe agradece e coloca
o Amuleto Encantado em seu
pescoço. Você pode agora sair do aposento, mas talvez se sinta na obrigação, por causa deste
grande presente, de dar a ele alguma coisa em troca. Se você tiver Peças de Ouro, resolva quantas
você dará a ele, retire-as da sua lista e vá para 183. Se você não tiver ouro, mas der a ele um artefato
que tiver recolhido, risque isso da sua lista e vá para 396. Se você não puder ou não quiser dar a ele
um presente em troca, vá para 270.`, 
  103: `Você lança o seu Encanto - mas nada acontece! Você continua caindo torre abaixo e finalmente se
...
agora também sua vida. Você fracassou na sua missão.`, 
  104: `Você experimenta a maçaneta, e ela gira. A porta está empenada, e você tem que empurrá-la para
que abra. O aposento no interior é algum tipo de sala de estar, com mesas, cadeiras, estantes e uma
coleção de cabeças de animais empalhados na parede. De repente, uma das cabeças de animais se
vira e olha para você. É alguma espécie de cachorro e late alto, em tom de advertência, tanto para
...
lentamente se reconstituir na forma de um homem alto. "O que você veio fazer aqui?", ele pergunta,
...
Volte para 25`, 
  105: `O vinho é bastante amargo e, ao saboreá-lo em sua boca, você sente uma sensação de ardência.
...
Á!
DRI Pisres prio cs`, 
  106: `Ela ri outra vez e diz a você que gosta de ver pessoas ficarem zangadas. De bom humor, ela
acompanha você por alguns metros. A conversa é difícil. Ela vê alguma coisa nas sombras distantes
e sai subitamente para investigar, permitindo que você avance para a entrada principal da Cidadela.
Vá para 218.`, 
  107: `Você pegou uma, duas, três ou quatro cabeças no seu laço. Estas cabeças lutam para se libertar, mas
a criatura continua a avançar. Você começa a entrar em pânico, enquanto tenta decidir o que fazer
em seguida. Vá para 184.`, 
  108: `Você agarra a corda firmemente, recua e toma impulso na direção do rio pútrido. Subitamente, a
corda passa a se movimentar e se contorcer com vontade própria! Você a larga rapidamente e cai no
chão. A corda cai por cima de você e se enrola em volta de você. Você compreende que não é uma
corda, mas, na realidade, uma longa COBRA DE ESGOTO, que se enrosca em torno do seu corpo e
de seu pescoço. Volte para 73.`, 
  109: `À criatura faz força contra a barreira de seu Encanto do Escudo. Para seu horror, ela é tão forte que
realmente consegue romper o escudo! Está agora em cima de você, e você tem que desembainhar a
sua espada. Volte para 30.`, 
  110: `Teste a sua Sorte. Se tiver sorte, você escolhe outro nome que é conhecido deles e eles chamam o
porteiro, que acaba aparecendo para deixar você entrar (vá para 251). Se não tiver sorte, fez outra
tentativa errada, e eles avançam na sua direção com suas armas prontas. Você terá que lutar contra
eles (vá para 288).`, 
  112: `Você se desvencilha da Cobra de Esgoto morta e tenta atravessar a água. Você chega do outro lado
sem maiores incidentes, mas está com certeza ansioso para tomar um banho rápido! Você continua
ao longo da passagem até chegar a uma encruzilhada, onde pode seguir em frente ou tomar a
passagem da esquerda. Se for para a esquerda, vá para 212. Se quiser seguir em frente, vá para 367.`, 
  113: `Você lança o Encanto da Fraqueza sobre o feiticeiro. Ele interrompe seus passos e olha para você.
Sua expressão se transforma em uma máscara de dor, e seus ombros sacodem violentamente.
Algum tipo de comoção interna terrível está tendo lugar dentro dele. Você quer esperar para ver o
que acontece (vá para 388) ou prefere desembainhar a sua espada e avançar (vá para 145)?`, 
  114: `Você aponta para a base do tentáculo e lança o seu encanto. Um rolo de fumaça e um clarão
luminoso irrompem do buraco no solo. Um tremor percorre o tentáculo e, felizmente, ele afrouxa.
Quando ele retorna para dentro do solo, você esfrega sua perna para recuperar a circulação e depois
parte na direção da entrada principal da Cidadela novamente. Lembre-se de descontar seu Encanto
do Fogo e vá para 218.`, 
  115: `À sua situação não é boa. Balthus Dire avança na sua direção e está quase em cima de você. Vá para`, 
  116: `Suas mãos super poderosas agarram a maçaneta e puxam. Ela sai na sua mão. Você fecha a mão e
desfere um soco no meio da porta. A madeira racha e quebra, permitindo que você entre no
aposento do outro lado. Vá para 210.`, 
  117: `Quando você puxa a sua arma, o feiticeiro faz o mesmo. Vocês estão agora próximos demais para
que qualquer um dos dois possa usar mágica e terão que terminar a batalha na luta de espadas mais
difícil de toda a sua vida. Vá para 337.`, 
  118: `A porta abre e uma criatura grande e abrutalhada sai. Possui um chifre pontudo no meio da testa, e
sua pele parece ser recoberta de armadura. Rosna para saber o que você quer e exige a senha antes
de deixar que você entre. Você sabe a senha? Se souber, vá para 273. Se não, você terá que forçar a
sua entrada (vá para 198).`, 
  119: `Você se vira para enfrentar o poderoso feiticeiro. Mas ele desapareceu. Você gira sobre os
calcanhares e o vê de pé atrás de você com um punhal afiado pronto para golpear. Você tenta saltar
para esquivar-se, mas é tarde demais. A lâmina se enterra nas suas costas... Você falhou na sua
missão.`, 
  120: `Você prova o vinho e balança a cabeça afirmativamente. A safra é excelente de fato, com um sabor
revigorante e rico. Você experimenta um pouco mais e começa a se sentir com a cabeça leve. Você
pode acrescentar dois pontos de ENERGIA e três pontos de SORTE por ter encontrado uma bebida
excelente a esse ponto. Você agradece ao Elfo e segue adiante. Volte para 95.`, 
  121: `Quando você parte para a porta, ela abre repentinamente à sua frente. Impossibilitado de travar seu
...
perde um ponto de ENERGIA por ter arranhado o seu joelho no chão de pedra. Vá para 257.`, 
  122: `Você tenta um ardil simples, mas ela não se deixa enganar por ele. Ela não permitirá que você siga
adiante, a não ser que você use sua magia. Volte para 47.`, 
  123: `Você se concentra, e imagens do Calacorm atravessam a sua mente. Você vê um prato cheio de
...
amarrada à parede e tendo seus pés queimados por uma tocha incandescente. Em seguida, você vê o
prato de serpentes de novo. Esta criatura evidentemente pensa sobre pouca coisa além dos prazeres
simples de sua vida miserável, e você não saberá muito sobre como escapar. É melhor você tentar
um Encanto do Ouro dos Tolos (vá para 211) ou um Encanto da Ilusão (volte para 35). Se não tiver
nenhum deles, vá para 283.`, 
  124: `Quando a cortina cai, a luz do dia penetra através da janela. Você compreende que perdeu toda a
...
caído como um fardo no chão. Você dá um passo à frente, e ele solta um grito de gelar o sangue nas
veias! "A cortina!
... Seu idiota!”... ele diz, ofegante, com uma voz que evidencia fraqueza e a
...
longe, e desaba no chão de bruços. Vá para 400.`, 
  125: `Quando você começa a correr, três flechas partem na sua direção, vindas de nenhum lugar. Teste a
sua Sorte. Se tiver sorte, todas elas erram o alvo, e você chega até o monumento e se abaixa atrás da
pedra. Se não tiver sorte, uma das flechas penetra em seu ombro, fazendo com que você perca cinco
pontos de ENERGIA antes de chegar ao abrigo do monumento. Vá para 209.`, 
  126: `Você pára para considerar a situação, em pânico. À sua frente, a passagem se bifurca para a
...
inteiramente preciso, como você verá. Vá para 316.`, 
  127: `Ela levanta a cabeça e solta um chamado no ar. Você interrompe seus passos ao ver as roupas
...
respiração difícil e apertando cada vez mais. Você distribui golpes com sua espada, mas isso causa
pouco dano aos FANTASMAS. O aperto o estrangula cada vez mais, e você terá que usar a sua
magia para se libertar, a não ser que tenha alguma coisa em sua mochila para oferecer à mulher.
Você:
...
Se você não tiver nenhuma dessas coisas, vá para 194.`, 
  128: `À medida em que o Encanto começa a ter efeito, você recebe vários pensamentos, conforme eles
...
estranha reverência por uma Escova de Cabelo entalhada, a qual aparentemente está em algum lugar
do aposento. Mas isso é tudo que você recebe, e você terá agora que se defender de seu ataque com
alguma coisa.
Você usará:
Sua espada?
Vá para 336
...
Um Encanto da Fraqueza?
Vá para 152`, 
  129: `Você luta com a caixa por algum tempo, tentando abri-la. Você puxa da espada e golpeia a caixa,
mas a única coisa que consegue é fazer sua espada perder o fio - de agora em diante, você terá que
...
Vá para 237`, 
  130: `O encanto não tem qualquer efeito. Risque-o da sua lista e desembainhe a sua espada. Vá para 333.`, 
  131: `Você rapidamente desembainha a sua espada, apontando-a na direção do Duende. Ele lança um
olhar para a lâmina e, para seu horror, ela verga molemente a partir do cabo, pendendo para baixo
como se fosse um cinto de couro. Parece que você não irá muito longe agindo com agressividade.
Talvez seja melhor você perguntar a ele o caminho para seguir adiante. Vá para 348.`, 
  132: `Você entra em um aposento que é evidentemente algum tipo de biblioteca. Há livro do chão até o
teto em cada uma das paredes, e diversas mesas e cadeiras estão alinhadas no centro do aposento.
Do outro lado, há um homem de pele escura sentado, que levanta os olhos de um livro para olhar
para você por cima de óculos estreitos. Há uma porta atrás dele. "Sim, o que é?" ele diz. "Que livro
você está procurando?" Você examina as várias estantes, que possuem legendas. Você pedirá a ele:
...
Vá para 375`, 
  133: `Você lança seu Encanto. Com sua força recentemente adquirida, você salta facilmente para o centro
do aposento por cima do fosso e rompe a fechadura da arca. Você xinga ao ver que não há nada lá
dentro, a não ser uma boa quantidade de chumbo para espingarda. Você salta, de volta rapidamente
...
Sorte. Se você tiver sorte, vá para 206. Se não tiver, volte para 82.`, 
  134: `Eles ficam admirados
com
sua
audácia.
Ao invés de esperar que eles falem, você age
...
para 245)?
ESTE =`, 
  135: `Os Miks são mestres da ilusão, capazes de se transformarem em qualquer forma ou ser que
quiserem. Não se sabe ao certo qual é a sua verdadeira natureza, pois muito poucos os viram em sua
forma natural, mas eles foram descritos por fontes bastante confiáveis como criaturas magras com
aparência de Elfos. São uma espécie agressiva, mas sua arma favorita é o Punhal-Agulha (uma faca
fina, como um estilete), como qual eles só podem atacar a curta distância. Embora eles possam se
transformar em qualquer coisa - homem, animal ou objeto - não são capazes de usar metais em seus
disfarces. Eles também são incapazes de lançar suas ilusões sobre outros objetos. Vá para 326.`, 
  136: `Todas elas protestam veementemente, mas você explica que tem suas ordens e começa a circular
pela cozinha.
Você investigará:
Os armários?
Volte para 17
...
Vá para 389`, 
  137: `O homem é velho e foi atingido na cabeça por algum tipo de porrete. Ele pede remédio, mas você
não tem nenhum. Você poderia usar um Encanto da Energia para recuperá-lo, e ele se oferece para
ajudá-lo se você o fizer. Se você usar a sua magia, vá para 383. Se não, terá que deixá-lo e continuar
ao longo da muralha (volte para 14).`, 
  138: `"Para que eu quero isso?" ela exclama. Mais uma vez, seus olhos ficam vermelhos e os jatos de
fogo são disparados na sua direção. Você lançará um Encanto do Escudo (vá para 376) ou deixará o
aposento e se encaminhará pelo corredor para o aposento do meio (volte para 64)?`, 
  139: `Todas as três facas erram e se cravam profundamente na porta atrás de você. Os Giras estão quase
...
Um Encanto do Fogo
Volte para 28`, 
  140: `Você sai do aposento e segue por um corredor curto. Alguns metros adiante, você se encontra ao pé
...
para 104)?`, 
  141: `O líquido tem um gosto salgado, e você começa a suar frio quando engole. Em seguida, você tem
tremores e tenta se aprumar no altar. Porém, você cai para frente, derrubando os outros dois cálices
...
cinzentas. Tem nas mãos um grande molho de chaves. Um rato atravessa a mesa em que ela está
sentada e ela grita alto... O grito acorda você com um sobressalto e você toma consciência de onde
...
Você sai da câmara, descansa alguns momentos e parte na direção da Cidadela. Vá para 156.`, 
  142: `Você experimenta a maçaneta, e ela gira. Você não consegue ouvir nada vindo do interior do
aposento, por isso você abre a porta para dar uma olhada. O aposento é pequeno, com um castiçal
...
excitada, e depois desmaia. Vá para 234.`, 
  143: `Você se concentra e lança seu Encanto. Aparece um tronco de Hidra, mas apenas isso. A criatura é
tão grande que um único Encanto não basta para criar uma réplica. Se tiver outro Encanto de Cópia
de Criatura, você poderá usá-lo (vá para 360), do contrário poderá procurar em sua mochila alguma
coisa que possa utilizar (vá para 226). Se você não puder ou não quiser fazer nenhuma dessas duas
coisas, vá para 184.`, 
  144: `A porta abre e você entra em um corredor estreito. Você segue por ele algum tempo, até que
finalmente chega a uma outra porta: desta vez é uma porta larga entalhada, com a inscrição "Adega
de Vinhos" gravada nela. Você experimenta a maçaneta e ela abre. Você espia do lado de dentro,
esticando o pescoço, e vê filas e mais filas de prateleiras cheias de garrafas contendo... vinho? O
aposento é pouco iluminado pela luz de várias velas. O fato de você abrir a porta fez com que uma
pequena sineta soasse, e uma figura vem se arrastando na sua direção por um dos corredores. Você
desembainhará a sua espada e se preparará para se defender (vá para 154) ou verá o que este sujeito
pode ter a dizer (volte para 56)?`, 
  145: `Você desembainha a sua espada e salta por cima da mesa sobre ele. Ele, enquanto isso, está
evidentemente lutando para resistir ao seu Encanto da Fraqueza... ou não? Ele esconde a cabeça nas
mãos e desvia o rosto de você. Volte para 80.`, 
  146: `Você pode pedir um favor a eles. Você:
...
Volte para 66`, 
  147: `O Golem desaba no chão e se parte em pedaços. Aliviado, você anda até as caixas e as examina.
Você tentará abrir:
À primeira caixa?
Vá para 260
A segunda caixa?
...
À terceira caixa?
Vá para 370`, 
  148: `O feiticeiro rosna com desprezo. "Então você pode culpar essa mesma gente da terra, que enviou
você com essa tarefa, pela sua morte!" Com estas palavras, ele puxa um punhal afiado do cinto e o
crava em seu peito. Você falhou na sua empreitada.`, 
  149: `Eles não estão interessados em sua companhia e sugerem que você siga o seu caminho. Você pode
...
monumento no centro do pátio (vá para 209) ou sentar-se ao fogo de qualquer maneira (vá para`, 
  150: `Você se abaixa rapidamente para se esquivar do Tridente. Não acerta o seu pescoço, mas raspa na
sua testa. Você perde dois pontos de ENERGIA e vai para 374.`, 
  151: `Os conjuntos de armaduras são de vários tamanhos e formatos, e você fica arrepiado de pensar nas
...
subindo, seja pela escada do lado esquerdo (volte para 19) ou pela escada do lado direito (vá para`, 
  152: `Você lança seu Encanto, e a criatura interrompe seus passos, sem entender o que aconteceu com ela.
Com algum esforço, ela apanha seu machado e vem na sua direção, mas evidentemente não é um
...
Se você derrotar a criatura, vá para 180.`, 
  153: `Você está indefeso diante da Górgona. Você tomba sem ação no canto, enquanto o feiticeiro
convoca seus guardas, que aparecem alguns minutos depois. Eles pegam você e carregam para fora
do aposento. O chefe deles pede instruções ao feiticeiro. "Execute o camponês!" é sua resposta.
Você fracassou na sua missão.`, 
  154: `Quando você puxa a espada, a figura pára e pega alguma coisa da bolsa em sua cintura. Quando ele
se aproxima mais, você pode ver que a criatura é um ELFO NEGRO; alto e magro, com orelhas em
forma de ponta de flecha e uma perna aleijada. Na sua mão, ele traz um pequeno mecanismo de
algum tipo. Ele vê você, manipula o mecanismo que subitamente se torna uma espada tipo estilete
na sua mão! Você avançará e lutará (vá para 275) ou abaixará a espada e conversará com ele (volte
para 56)?`, 
  155: `Sua mão vai até o cabo da espada. Você desembainha a lâmina. Mas não golpeia o feiticeiro. Sua
própria vontade impõe que você ofereça a sua arma a ele, o que você faz. Ele aceita. Volte para 65.`, 
  156: `Enquanto você caminha pelo pátio ao ar livre, repara que está andando ao longo de uma pequena
elevação, quase que como um encanamento enterrado que fosse da Torre Negra para o templo.
Você se abaixa para investigar isso; poderia ter sido feito por algum tipo de toupeira? Quando você
toca na elevação, ela se retrai e, para seu horror, um longo tentáculo cinzento irrompe do solo e se
...
Volte para 114`, 
  157: `O feiticeiro grita de agonia e desvia o rosto de você, segurando a cabeça. Você se precipita para a
...
baterá em retirada rapidamente (vá para 232)?`, 
  158: `A fera geme quando o encanto faz efeito. O peso imenso é de fato um fardo sem sua força normal.
Ela desaba sem energia, incapaz até mesmo de se levantar do chão. Você caminha até ela e enterra a
espada em seu peito. A infeliz criatura jaz morta a seus pés. Volte para 77.`, 
  159: `Você lança seu Feitiço da Fraqueza e deixa transcorrer um tempo na esperança de que a força da
...
intensa. Você se sente fraco e perde a consciência quando as mandíbulas se fecham na sua garganta.
Vá para 323.`, 
  160: `A Cabeça de Cachorro voa na sua direção e arranca o engenho de sua mão. Ao examiná-lo, as
...
atravessar furtivamente o aposento na direção da porta no outro canto. Vá para 206.`, 
  161: `Ela fica profundamente ofendida com sua indiferença. O Redemoinho se ergue mais uma vez, e
agora ela joga você no chão. Você tenta engatinhar para longe, mas ela se coloca bem na sua frente,
...
Vá para 390`, 
  162: `Você sente o poder se espalhando pelo seu corpo. As criaturas vêem seus músculos proeminentes se
endurecem diante de seus olhos e ficam imóveis. Sua mão agarra o cabo da espada e você puxa a
lâmina com decisão. Mas, para seu desespero, sua nova força é difícil de controlar, e seu primeiro
golpe com a espada faz com que a arma saia voando pelo ar e caia a vários metros de distância!
Você agora terá que enfrentá-los de mãos nuas, ou poderá usar sua nova força para saltar para longe
pela encosta da colina. Se você quiser lutar, os índices das criaturas são (lute com elas uma de cada
vez):
HABILIDADE
ENERGIA
MACACO-CACHORRO`, 
  163: `Você dá um gole e engasga. Esse vinho é horrível! O Elfo está olhando para você com expectativa,
e você não deve insultá-lo, por isso você toma mais um gole, fazendo caretas enquanto o líquido
desce. Você agradece muito a ele, mas explica rapidamente que precisa ir voltando. Você parte na
...
pontos de ENERGIA pela sua náusea. Volte para 95.`, 
  164: `A porta é de metal sólido, e não há quantidade de pancadas, mesmo com um Encanto da Força, que
...
no caminho de vinda. Você pode usar um Encanto da Levitação, se tiver, para levá-lo para fora da
Cidadela. Terá que tentar de novo amanhã à noite...`, 
  165: `Quando você sente a força se espalhar pelo seu corpo desembainha a espada e crava na muralha
...
metade do caminho, contudo, sua força começa a diminuir, e você compreende que está retornando
...
para 398) ou gritar pedindo ajuda (vá para 202).`, 
  166: `Quando você morde a carne, ouve um ganido de dor bem baixo vindo de algum lugar distante. A
carne está dura e salgada, mas o gosto não é tão ruim, por isso você dá mais uma dentada. Você
ouve um grito mais uma vez, e dessa vez o pedaço de carne voa da sua mão! Quando você se abaixa
para pegá-lo, ele resiste. Você se dá conta de que esta carne ainda está viva e grita quando você a
...
vez que o número obtido for maior do que o seu índice de HABILIDADE, desconte dois pontos de
...
parede do lado esquerdo (volte para 13) ou pela porta do lado oposto ao que você entrou (vá para`, 
  167: `Você se inclina sobre o caldo e cheira. Argh! É de embrulhar o estômago! Você pergunta a elas que
diabo é aquilo e, ao levantar os olhos, você vê que uma delas está silenciosamente fazendo sinais na
...
cabeça. Teste a sua Sorte. Se você tiver sorte, vá para 224. Se não tiver, vá para 331.`, 
  168: `Você tira o Amuleto e o coloca em cima da cabeça. Os Ganjees ficam ofegantes! "Siga viagem,
...
Ng
NR`, 
  169: `O aposento em que você está é uma espécie de grande salão de jantar. Uma mesa longa, de tamanho
suficiente para que quarenta ou cinquenta pessoas sentem, ocupa o centro, ladeada por cadeiras. Há
várias portas e passagens que dão saída do aposento, mas você está particularmente interessado em
...
Volte para 151`, 
  170: `Quando a força surge no interior do seu corpo, você arranca na direção da porta com toda a energia.
Jogue um dado. Se você obtiver 1, 2 ou 3 pontos, a porta não cede, e você terá que descontar 2
pontos de ENERGIA. Se você tirar 4, 5 ou 6 pontos, você derruba a porta (vá para 292). Repita este
procedimento até ter êxito ou, se você preferir, tente a porta do meio (volte para 64), ou a porta mais
distante (vá para 304).`, 
  171: `Para este jogo, você precisará de pelo menos uma Peça de Ouro. Se não tiver nenhuma, poderá usar
um Encanto do Ouro dos Tolos e levar o seu Ouro dos Tolos para o Mestre de Jogos, que dará a
você dez Peças de Ouro por ele. (Se você não tiver nem Peças de Ouro, nem Encantos do Ouro dos
...
Tolos, antes de prosseguir.`, 
  172: `Você avança e desfere um golpe na criatura. Com um ruído estridente, sua espada repica no corpo
...
um Encanto (volte para 26), ou usar alguma coisa que esteja na sua mochila (vá para 289).`, 
  173: `Você se concentra com toda força, e um gás verde e espesso esguicha de seu dedo na direção da
criatura. Ela compreende que sua própria rotação aspirará o gás para o interior de seu Redemoinho e
começa a recuar. Depois que ela se afastou o suficiente, você dispara na direção da Torre Negra. Vá
para 218.`, 
  174: `A passagem faz voltas e mais voltas, até que acaba por terminar em um lance de escadas que sobe.
Você caminha escada acima e chega a uma passagem curta que termina em um beco sem saída. Ao
examinar a parede, você descobre uma pequena alavanca, a qual você puxa. A face da rocha à sua
frente abre um pouco e se fecha atrás de você quando você passa. Você está agora diante de uma
...
arrebentá-la em pedaços (volte para 116)?`, 
  175: `A criatura nunca ouviu falarem nenhum Pincus no interior da Cidadela. O Cachorro-Macaco que
está segurando a clava rosna e dá um passo adiante. Você pode escolher outro nome rapidamente
(volte para 110) ou se preparar para lutar contra eles (vá para 288).`, 
  176: `Quando você se aproxima, ela se volta para olhar para você. Sem se perturbar nem um pouco com a
...
correndo em volta do caldeirão, quase a ponto de se tocarem. Os dois param, se encarando com o
...
cozinha (vá para 265).`, 
  179: `Quando você sai das sombras na direção do centro do pátio, uma voz no vento grita: "Pare! Fique
...
zune pelo are cai próximo a seu pé esquerdo. Você pula para trás. Mas ainda assim não vê ninguém.
...
Vá para 341`, 
  180: `O grande Gark jaz morto ao solo. Você espera um minuto para ver se a agitação atrairá algum
...
para 99.`, 
  181: `Você lança o Encanto no ar. Ao fazer isso, o Tapete Voador passa flutuando por você e, para sua
consternação, aparece um segundo tapete idêntico
e começa a voar em círculos pelo aposento.
Subitamente, o ar fica cheio de objetos voadores. A Cabeça de Cachorro se desprende da parede e
morde selvagemente o seu braço. Você perde dois pontos de ENERGIA. O homem, que se
transformou em uma Cobra, arrasta-se até você e, dando um bote, morde a sua perna. Teste a sua
Sorte. Se você tiver sorte, os dentes da Cobra apenas arranham a sua pele. Você perde mais 2
pontos de ENERGIA. Se você não tiver sorte, os dentes penetram fundo em sua perna, que começa
a latejar de dor. Você compreende, num relance que deixa você cego, que a mordida é fatal, e
desfalece no chão, apertando a ferida e se contorcendo em agonia. Conforme o veneno vai fazendo
efeito, sua cabeça gira, e a consciência desaparece. Você falhou na sua missão. Se tiver sobrevivido,
...
aposento rapidamente pela outra porta (volte para 25).`, 
  182: `Você se sente sugado para o interior do aposento. Como que por um passe de mágica, sua tocha
...
encolhe horrorizado, atira-se no chão e começa a se sentir muito assustado. Você perde 1 ponto de
...
Vá para 248`, 
  183: `Ele agradece a você efusivamente. Você ganhou um amigo. Vá para 270.`, 
  184: `Enquanto você está decidindo o que fazer em seguida, a Hidra avança. Duas das suas cabeças se
projetam e mordem você; uma no braço e outra no pescoço. Seus dedos aguçados rasgam a sua pele
e penetram fundo. Tudo está perdido. Você falhou na sua missão.`, 
  185: `A porta se abre para um corredor estreito, que faz uma curva fechada para a esquerda, continua por
vários metros e então termina por fim em uma porta. Você põe a mão na maçaneta. Volte para 13.`, 
  186: `O homem alto concorda e convence o mais baixo de que é um preço justo. O homem baixo
resmunga e pragueja, oferecendo seis e depois sete Peças de Ouro, mas o preço foi fixado a oito.
Você mesmo pode, se quiser, oferecer oito Peças de Ouro ao homem alto, embora tenha que fazer
aparecer Ouro dos Tolos para dar a ele. Se quiser fazer isso, use um Encanto do Ouro dos Tolos e
volte para 15. Se não quiser, o homem baixo acaba por concordar como preço, compra o punhal e
vai embora. Você pode ficar para conversar com o homem alto (volte para 83) ou continuar no seu
caminho (vá para 245).`, 
  187: `Você se concentra na mente do feiticeiro. Palavras e imagens cruzam a sua cabeça. Dois segundos
depois, não há mais nada. Você levanta os olhos para Balthus Dire, que encara você fixamente.
"Não tente ler os pensamentos de Balthus Dire!", ele ordena. Você se concentra de novo, mas ainda
assim não recebe nada, pois ele está bloqueando o seu Encanto. Você reflete por um segundo sobre
as imagens que recebeu: um mapa embaixo da mesa de planejamento de batalha... uma sensação de
horror diante de um grito altíssimo... uma luz ofuscante... um anel no dedo dele... uma espada com
lâmina de navalha... e você.
Ele está agora sussurrando em voz bem baixa, observando você com um dos olhos. Ele ergue uma
das mãos no ar e concentra seu olhar nela. Ele sacode a mão no ar, para a frente, para trás e de um
lado para outro, cada vez mais rápido. Com estrondo, ele desce a mão de encontro à mesa. Você cai
...
equilibrado e venha agora andando na sua direção, você não consegue se levantar de jeito nenhum.
...
Mas, se você não tiver nenhum deles, volte para 115.`, 
  188: `Um clarão de luz súbito e intenso irrompe à sua frente. Você protege os olhos e depois os esfrega -
...
Volte para 51`, 
  189: `Você pode usar qualquer um dos seguintes Encantos:
Encanto da Ilusão
Vá para 319
Encanto do Escudo
Volte para 130
...
Se você não tiver nenhum deles, terá que usar sua espada. Vá para 333.`, 
  190: `Uma cópia perfeita do Golem forma-se na sua frente. Você ordena que ela ataque o verdadeiro
Golem, que está agora quase em cima de você. Resolva a batalha dos Golems:
GOLEM
HABILIDADE 8
ENERGIA 10
Se a sua criação vencer o original, volte para 147. Se não vencer, você terá que resolver o confronto
sozinho. Se vencer, poderá ir também para 147.`, 
  191: `Você sufoca quando o Encanto se materializa diante de você. Uma réplica perfeita da sua pessoa,
armado como você está, surge agora de pé na sua frente.
A uma ordem do feiticeiro, seu sósia
avança, e você terá que lutar contra ele. Ele possui os mesmos índices de HABILIDADE,
ENERGIA e SORTE que você tem. A única vantagem que você pode ter é usar a sua SORTE para
causar danos maiores ou minimizar ferimentos - seu sósia não poderá usar a SORTE dele aqui. Se
você vencer, volte para 119.`, 
  192: `Você lança o Encanto bem na hora. O projétil atinge o seu escudo mágico e se espatifa contra ele,
escorrendo para o solo. Você examina a pasta que ficou no escudo para ver o que era. Você quase
foi atingido por um tomate! No centro do aposento, a figura adormecida está se mexendo. Volte
para 29.`, 
  193: `Escolha um Encanto:
Ouro dos Tolos
Vá para 211
...
Se você não tiver nenhum deles, vá para 283.`, 
  194: `O aperto no seu pescoço aumenta, e sua última lembrança é de medo - dessas criaturas inumanas
com seus rostos há muito já mortos, felizes com a sua morte. Você falhou na sua missão.`, 
  195: `Os olhos de Balthus seguem você quando você se abaixa, mas você fica protegido pela mesa de
...
| |
so`, 
  196: `O aposento é de fato uma despensa. Num primeiro momento, os cheiros estranhos - uma mistura de
comida doce, temperada e azeda - pegam você de surpresa. Há vários tipos de carne pendurada sem
ganchos ao longo de uma das paredes. Uma prateleira de queijos contém mais ou menos uma dúzia
...
experimentar alguma das comidas (volte para 45), do contrário poderá sair pela porta na parede do
lado esquerdo (volte para 13), ou pela porta na parede do lado direito (vá para 281).`, 
  197: `As escadas estão bastante gastas e estalam sob o seu peso. Cuidadosamente, você sobe até a sacada.
Vá para 363.`, 
  198: `Você pensa rapidamente, e depois enfia a mão em sua mochila e tira um punhado de ervas.
...
entrar sem a senha, e ele avança na sua direção com a lança em riste (vá para 290).`, 
  199: `O feiticeiro se transformou em uma GÓRGONA, uma criatura extremamente perigosa, que tem o
...
cai no chão. Sua consciência some aos poucos, enquanto você vai se tornando uma estátua de pedra,
morto aos pés de Balthus Dire... Você falhou na sua missão.`, 
  200: `Ão seu primeiro movimento, a criatura parece sair de seu transe e caminha na sua direção. Ao ver
isso, você pode correr para a porta do outro lado do aposento (vá para 237), ou partir na direção das
caixas e arriscar-se a enfrentar este gigante silencioso (volte para 98).`, 
  201: `Eles apontam na direção das duas portas. A da esquerda, eles dizem, leva você para a cozinha, onde
...
realizados os banquetes. Vá para 270.`, 
  202: `Depois de vários minutos de gritaria, você ouve vozes que se aproximam, falando em uma língua
...
terminada. E lembre-se - estranhos não são bem-vindos na Cidadela do Caos...`, 
  203: `Ao correr para as portas, você tropeça, permitindo que a criatura ganhe terreno. Ela agarra seu braço
com uma das mãos e atira você para o outro lado do aposento. Você aterrisa com estrondo contra a
parede, embaixo do espelho. Você agora terá que desembainhar a sua espada (volte para 16), ou se
preparar para usar um Encanto (volte para 11).`, 
  204: `Você prende a respiração e dá um passo adiante, entrando na água lodosa. Pouco depois, você sente
...
estivesse olhando para você, e depois cai na água de volta com estrépito. Você compreende que não
é uma trepadeira, mas sim uma longa COBRA DE ESGOTO, que agora está deslizando na sua
direção. Volte pala 73.`, 
  205: `O homem alto fica revoltado com seu preço, mas o outro concorda. A discussão torna-se mais
intensa,
e o homem alto desembainha a sua espada. O homem mais baixo faz a mesma coisa e,
vendo-se ameaçado, você age igualmente. É você e o homem mais baixo contra o homem alto.
Você tem que resolver esta batalha. Antes de começar cada Série de Ataque, jogue um dado. Se o
número for ímpar, o homem alto atacará o mais baixo primeiro, e você, pessoalmente, poderá
ignorar essa Série de Ataque. (Embora você tenha que jogar os dados para o homem baixo mesmo
assim). Se o número for par, o homem alto parte para cima de você (e o mais baixo poderá ignorar a
Série de Ataque). Se o homem mais baixo morrer durante a batalha, o mais alto terminará lutando
contra você.
HABILIDADE
ENERGIA
HOMEM ALTO`, 
  206: `Você sai pela porta e se encontra ao pé de outra escada em espiral que leva ao interior da Terra
...
lentamente. Volte para 182`, 
  207: `Você abre a porta e espia a escuridão à sua frente. Você dá uns dois passos adiante, dando tempo
para que seus olhos se acostumem ao escuro. Você fecha a porta atrás de você, dizendo adeus ao
Duende. Volte para 188.`, 
  208: `A arma do Homem-Aranha é sua mordida, que é altamente venenosa. Quando ele morde, você sente
o veneno se espalhando pelo seu organismo, adormecendo seus nervos. Quando você cambaleia e
cai ao chão, ele ataca repetidamente. Sua última lembrança é a cara pequena e feia dele mordendo
seu pescoço. Você fracassou na sua missão.`, 
  209: `Você pousa os olhos sobre a estranha estrutura. Não parece ser uma fonte, mas alguma espécie de
...
vá para 362.`, 
  210: `Você agora está em um aposento grande e redondo. É Iluminado por uma única tocha, presa a uma
das paredes. Não há mobília no aposento,exceto uma mesa de madeira rústica e uma cadeira no
centro. Flutuando acima da mesa
- dormindo profundamente
- há um homem muito pequeno,
vestido com pantalonas e camisa verdes. Ele não chega a ter mais de um metro de altura, e você não
consegue acreditar que ele esteja ainda dormindo depois de sua entrada barulhenta! Você ouve um
rangido e vira-se para a direita a tempo de ver uma pequena catapulta disparar um projétil de algum
tipo direto na sua direção. Vai atingir você, a não ser que você use um Encanto do Escudo! Se você
usar este Encanto, volte para 192. Se não puder (ou não quiser), vá para 359.`, 
  212: `Tomando a bifurcação da esquerda, você segue um caminho que acaba por se juntar a uma outra
...
que ele acaba por se alargar. Volte para 90.`, 
  213: `Você desembainha a sua espada bem a tempo, já que o Anão está quase em cima de você. Lute
contra um de cada vez:
HABILIDADE
ENERGIA
ANÃO`, 
  214: `Você tira a tampado Frasco e esparrama o líquido verde sobre a criatura. Ela rosna e grita no ar,
...
uma fumaça sobe pelo ar. Alguns momentos depois, a criatura jaz morta no chão. Volte para 62.`, 
  215: `Você terá que inventar alguma história para estas mulheres horrorosas. Você dirá a elas que o
Capitão da Guarda ordenou que se fizesse uma inspeção na cozinha delas, depois de uns dois casos
de intoxicação alimentar (volte para 136), ou dirá que pegou o caminho errado e está procurando o
certo para seguir adiante (volte para 41)?`, 
  216: `Qual será sua tática? Você pode dizer à criatura que você é um convidado (vá para 294), ou poderá
...
para 36).`, 
  217: `Você gira a maçaneta o mais cuidadosamente possível, de maneira a surpreender o que quer que
...
ans
aa`, 
  218: `Há uma grande porta de madeira à sua frente, firmemente trancada. Você pode bater três vezes para
chamar o guarda (volte para 118) ou usar um Encanto da Força para tentar abri-la (volte para 94).`, 
  219: `Você se abaixa e protege a cabeça. Uma garrafa atinge você, depois outra e mais outra - mas você
...
de Vinhos. Volte para 95.`, 
  220: `As facas atingem o seu escudo mágico e caem ao chão. Os Giras, da mesma forma, esbarram no
...
mira. Você terá que atacá-los primeiro com sua espada. Resolva esta batalha (lute com um de cada
vez):
HABILIDADE
ENERGIA
Primeiro Gira`, 
  222: `Ao se esgueirar pela muralha, você ouve um gemido baixo uns poucos metros adiante. Quando se
...
continuar ao longo da muralha (volte para 14)?`, 
  223: `Ela faz uma careta ao olhar para a coisa pequena e feia, puxando os cobertores até o pescoço. Volte
para 138.`, 
  224: `Você rapidamente joga a cabeça para trás e evita por pouco as mandíbulas do Peixe Abocanhador.
...
elas gritam enquanto empurram você pela porta. Vá para 265.`, 
  225: `Ele concorda inteiramente. Este artefato é extremamente valioso. O homem mais baixo explica que
ele simplesmente não tem tanto dinheiro, e se afasta na escuridão. O homem alto oferece o punhal a
você pelo preço de ocasião de nove Peças de Ouro. Você pode usar um Encanto de Ouro dos Tolos
...
você pode desculpar-se e seguir adiante (vá para 245).`, 
  226: `Você pode tirar de sua mochila qualquer uma das seguintes coisas, se as tiver recolhido no
caminho:
Um Espelho de Prata
Vá para 312
Um Velo de Ouro
...
Se você não tiver nenhuma dessas coisas, volte para 184.`, 
  227: `Eles começam a ficar muito zangados com seus modos. Os ânimos se exaltam, e eles começam a
gritar. Repentinamente, você é dominado por eles. Você luta, mas um deles golpeia você na cabeça
com o cabo da espada. Sua cabeça roda, e o aposento escurece, quando você perde a consciência.
Vá para 234.`, 
  228: `A porta trancada é muito forte e feita de carvalho sólido. Não é provável que você consiga arrombá-
...
Vá para 296`, 
  229: `Você bate a porta, fechando-a ao passar. Você segue por uma passagem curta e estreita, que dá
...
(volte para 50), ou usar um Encanto da Força (volte para 164).`, 
  230: `“Veio ganhar algum dinheiro, né?” diz o Macaco-Cachorro."Bem, você pode dividir um pouco dos
seus lucros conosco!" Como você não tem nada para oferecer a eles, pode tirar uma pedra de sua
bolsa e lançar um Encanto do Ouro dos Tolos sobre ela, oferecendo uma pepita de ouro a eles (volte
para 96), ou pode preparar-se para a batalha (vá para 288). Desconte o Encanto do Ouro dos Tolos
dos seus Encantos, se você o usar.`, 
  231: `Você bate na porta com o ombro. Teste a sua Sorte. Se tiver sorte, a porta cede e abre (volte para
196). Se você não tiver, você machuca o ombro - perde um ponto de ENERGIA - e tem que Testar
a sua Sorte - outra vez, repetindo este procedimento até que você tenha sorte. Você perde um ponto
de ENERGIA por cada tentativa sem êxito. Quando você finalmente conseguir arrombar a porta,
volte para 196. Do contrário, se seu ombro começar a doer demais, você pode retornar à primeira
encruzilhada que você encontrou e seguir pela outra passagem a qualquer momento (vá para 243).`, 
  232: `Você recua horrorizado diante da criatura que está à sua frente. Lembrando-se das lendas que você
ouviu contar quando criança, você compreende que está enfrentando uma GÓRGONA, cujo olhar
tem o poder de transformar você em pedra! Teste a sua Sorte. Se tiver sorte, volte para 111. Se não
tiver, volte para 72.`, 
  233: `Você evita o impacto do Tridente em cheio, mas uma de suas pontas crava-se no seu ombro.
...
gritando de dor ao fazê-lo. Você perde cinco pontos de ENERGIA pelo ferimento e vai para 374.`, 
  234: `Você acorda em um aposento sujo, com paredes ásperas cortadas na rocha. As barras de ferro na
janela e na porta confirmam que você está em algum tipo de cela de prisão, conforme você
desconfiava. Não há muito que você possa fazer, além de ficar sentado no colchão de palha que está
em um canto até que alguém apareça. Mais ou menos uma hora depois, você ouve o barulho de
alguma coisa que se arrasta do lado de fora. Olhando através das barras da porta, você pode ver uma
criatura com aparência de lagarto que se arrasta descendo o corredor, trazendo nas mãos uma
moringa e uma terrina. O animal tem duas cabeças que conversam entre si enquanto ele caminha.
Sua pele é cinzenta e coberta de escamas, e uma cauda longa se estende pela passagem atrás dele.
Ele pára na sua porta e empurra a moringa e a terrina por uma pequena abertura para dentro de sua
cela, e depois se afasta para sentar-se
a uma mesa do outro lado do corredor. Você recebeu pão e
caldo. Você vai comer e beber ou vai chamar esta criatura, un CALACORM!? Para se servir da sua
comida, vá para 397. Se quiser gritar para o Calacorm, volte para 69.`, 
  235: `Temeroso de que a agitação possa ter atraído atenção, você espia na escuridão. Nada parece estar
acontecendo. Examinando os bolsos das criaturas, você acha oito Peças de Ouro, uma chave cor de
cobre e um vidro contendo um unguento escuro e cremoso. Você pode levar dois desses com você:
...
muito rara. Há o suficiente para duas doses no frasco, e cada uma delas tem o efeito de aumentar o
...
beber a Poção, você não precisa riscar esse Encanto da sua lista. Lembre-se de que esta Poção só
funcionará duas vezes. Agora você pode seguir adiante, tanto na direção da Cidadela (vá para 245)
quanto na dos dois homens que estão conversando sob a luz da tocha (vá para 269).`, 
  236: `Eles aceitam as suas Amoras de bom grado, jogando-as para dentro da boca e mastigando. Alguns
segundos depois, eles adormecem um por um. Quando todos os três estão dormindo, você caminha
...
verdadeiramente de valor ali, por isso você sai do aposento pela porta do outro lado. Volte para 140.`, 
  237: `Você abre a porta e sai em uma passagem que segue na direção leste por vários metros, terminando
ao pé de urna escadaria. Você sobe as escadas e acaba chegando em uma passagem estreita. A uma
pequena distância mais aliante, você pode ver uma abertura para um aposento grande e bem iluminado.
Você segue nessa direção. Volte para 169.`, 
  238: `Ele indica uma seção das estantes, e você leva um livro para uma das mesas para ler. O livro é
extremamente informativo, traçando a história da Cidadela. A Torre Negra foi construída pelo avô
de Balthus Dire. À medida em que foi se tornando um santuário para as forças do mal, a lei e a ordem foram
gradualmente dando lugar ao caos, devido à luta das criaturas monstruosas para ascender na hierarquia do poder.
O avô de Dire acabou se vendo na necessidade de se proteger de
seus próprios seguidores, criando vários sistemas de segurança entre as criaturas e seus próprios aposentos,
destacando-se entre eles a Armadilha do Poço da Perdição e uma Fechadura de Combinação mágica na porta
de seu próprio quarto. A combinação da fechadura é 217.
Você lê mais sobre a Cidadela. Você pode então escolher entre perguntar ao homem sobre a seção dedicada a
Balthus Dire (volte para 18), ou a seção das Criaturas de Rocha Escarpada (vá para 375),
ou ainda sair do aposento pela porta do outro lado (volte para 31).`, 
  239: `Você tem uma idéia. Você fazum laço com a corda, com um nó corrediço na ponta.
Girando a corda acima de sua cabeça, você tenta laçar a arca. Depois de diversas tentativas, seu laço circunda a arca,
e o nó corrediço se aperta em torno dela. Você puxa e a arca se mexe. Você puxa mais, e ela cai pela borda dentro
do fosso - mas, para sua decepção, o peso da caixa é enorme e arrasta você
junto com ela! Se você tiver um Encanto da Levitação, use-o e vá para 379.
Do contrário, volte para 82.`, 
  240: `Você ergue uma mão flamejante, passando-a pelas costas da vestimenta que está apertando seu pescoço
A roupa se incendeia, e um grito silencioso sai da boca morta dentro dela. Os outros Fantasmas recuam.
Você ateia fogo a mais uns dois, enquanto eles batem em retirada. Infelizmente, eles estão perto demais,
e você perde dois pontos de ENERGIA pelas queimaduras que sofre. Andando cuidadosamente
para a frente, você mantém os Fantasmas à distância até passar em segurança pela mulher. Volte para 6`, 
  241: `Você atinge a criatura com um golpe que causa danos. Mas, para sua infelicidade, a espada fica
...
pode tentar continuar a luta com as mãos nuas ou lançar um Encanto da Força. Se você lutar com sua força
normal sem uma arma, terá que descontar três pontos de seu índice de HABILIDADE pelo resto da luta.
...
você vencer, poderá recuperar a sua espada e ir para 77.`, 
  242: `As garrafas e barriletes contêm centenas de diferentes vinhos. Alguns são extremamente velhos e
valiosos. Em um dos cantos do aposento, há uma mesa posta para a degustação, com duas garrafas e
copos. Você vai provar uma amostra do Vinho Tinto (volte para 24) ou do Vinho Branco (volte para
105), ou ainda não experimentará nenhum deles e seguirá adiante (volte para 95)? Se você resolver
sair, poderá levar com você uma garrafa de vinho de uma das prateleiras para a viagem.`, 
  243: `A passagem se estende por vários metros e depois termina em uma porta. Você escuta junto à porta
...
semelhante a um Goblin, adormecida no chão. Você pode se arriscar a entrar no aposento na ponta
dos pés (vá para 352), ou retornar à encruzilhada e tentar a passagem da direita (volte para 2).`, 
  244: `Quando você se concentra no seu Encanto, os Giras param. Eles estão evidentemente apreensivos
em relação ao que você está planejando. De repente, diante de seus olhos peludos, você desaparece!
...
(volte para 243), deixando os Giras procurando por você em vão.`, 
  245: `Você parte na direção da Cidadela. Embora o ar da noite esteja calmo, você ouve um assobio fraco,
que rapidamente fica cada vez mais alto, até que uma forte lufada de vento subitamente atinge você
com tamanha força, que você mal consegue se mexer no sentido contrário. Você protege os olhos,
...
mensagem chega até você. Ela parece considerar a sua aparência como ofensiva e está desafiando
você com palavras agressivas. Você segura a sua espada, mas ela ri. Você vai ignorá-la e continuar
(volte para 161), vai conversar com ela (vá para 390) ou usará a sua magia para se livrar dela (volte
para 47)?`, 
  246: `Você desaparece. Você pode, porém, ainda observar o Calacorm da sua cela. Para sua consternação,
a fera não reparou que você sumiu! Você espera pacientemente, mas não adianta, e agora você
começa a se preocupar, porque o Encanto em breve perderá o efeito. Você chuta a terra junto a seus
pés. A criatura levanta a cabeça e corre para a porta da sua cela. Você não está em parte alguma!
Ele abre a porta e entra na cela, mas, ao fazê-lo, seu Encanto começa a se dissipar. "Tentando me
enganar, hein?”, diz o Calacorm, agarrando você. Será preciso agora lutar contra a criatura:
CALACORM
HABILIDADE 9
ENERGIA 8
Você pode lançar um Encanto da Fraqueza sobre ele, o que reduzirá sua HABILIDADE para cinco.
Se você derrotar a criatura, poderá sair da cadeia pela passagem que segue na direção norte (volte
para 174).`, 
  247: `Eles ficam chocados com seu pedido. Você pragueja ao compreender que não deveria ter revelado
sua verdadeira missão a eles. Todos eles tagarelam agitados, por algum tempo, depois voltam-se na
sua direção. Juntos, todos eles sopram com força. Para sua surpresa, o sopro deles é como um vento
de tempestade, e você é atirado para trás de encontro à parede. Sua cabeça bate na parede áspera e
rochosa, e você perde os sentidos. Volte para 234.`, 
  248: `Um silêncio se espalha pelo aposento. Subitamente, um grito de gelar o sangue nas veias vem de
...
consegue chegar até a porta, abri-la violentamente e disparar por ela. Porém, você se esqueceu que
está no alto de uma torre, e que a sacada não tem corrimão... Você se precipita pela borda e cai
diretamente. Se você tiver um Encanto da Levitação, volte para 103. Do contrário, você se estatela
como um pacote na base da torre, e seu corpo despedaçado solta o último suspiro...`, 
  249: `A passagem termina à sua frente em uma porta de madeira. Há um letreiro afixado nela, dizendo
"DESPENSA". Você cola os ouvidos junto a ela, mas não ouve nada. A porta está trancada. Se você
tiver uma Chave de Cobre, poderá tentar usá-la aqui (vá para 392). Do contrário, você pode tentar
...
=— ma
BA`, 
  250: `Você se concentra e, diante de seus olhos, começa a se formar um ciclone que cresce e devasta o
aposento. Cadeiras, livros e todo tipo de objetos voam pelo ar e são postos a girar em torno do
aposento, deixando você intacto. Você dá um passo adiante, mas pára repentinamente ao ouvir um
...
insuportável, e você desaba no chão, já consciente de que a mordida era venenosa. Tome cuidado
com os Miks na sua próxima aventura. Esta terminou aqui...`, 
  251: `Você caminha em frente, entrando em um pátio aberto e espaçoso, circundado por grandes muros.
Há várias tochas queimando, e grupos de figuras se movimentam na escuridão. Há um monumento
...
Vá para 321`, 
  252: `Você laçou cinco ou seis das suas cabeças! Ela luta para se livrar do nó. Com um bote, a Miríade é
arrancada da sua mão. Mas, ainda assim, a criatura foi suficientemente ameaçada para permitir que
você salte na direção da porta de outro lado do aposento. Volte para 229.`, 
  253: `O queijo está realmente maduro demais, mas, ao comê-lo, você se sente estranhamente reconfortado.
O sabor, uma vez dentro de sua boca, é muito apreciável, e você come diversos bocados. Você pode acrescentar
um ponto de HABILIDADE, três pontos de ENERGIA e um ponto de SORTE por esta refeição, e depois pode sair.
Se você decidir tentar a porta da parede de lado esquerdo, volte para 13. Se quiser experimentar a porta oposta à que
você entrou, vá para 281.`, 
  254: `Você rola escada abaixo, atravessa o aposento e finalmente se choca contra a parede do outro lado
do salão. Você torce o cotovelo seriamente. Perde por isso um ponto de HABILIDADE e dois pontos de ENERGIA,
e depois sobe pela outra escadaria. Volte para 197. 255 A criatura olha para você. Seus olhos se estreitam.
Há urna lança longa em suas mãos, que ela rapidamente aponta na sua direção. "Esta não é a senha!" ela
grita e sai para a batalha.
Teste a sua Sorte. Se você tiver sorte, pensa rapidamente em um blefe (volte para 198).
Se não tiver sorte, você gagueja e a criatura avança para lutar (vá para 290).`, 
  256: `O feiticeiro sorri. "Então você se juntará a mim!" ele ri. "Mas primeiro eu preciso garantir a sua
lealdade genuína." A mão dele pousa em sua testa. Ele fecha os olhos e se concentra. Você sente a
sua vontade se esvaindo. Seu espírito de luta está abandonando você. Depois de alguns momentos, ele retira a mão.
Você está livre na frente dele. Você se inclinará para saudá-lo como seu mestre (volte para 65) ou pegará sua
espada e cravará nele (volte para 155)?`, 
  257: `Você olha à sua volta no aposento. Está iluminado somente pela sua tocha. Embora seja um aposento bastante
grande, possui pouca mobília, com apenas urna grande rocha, cortada de modo a servir de mesa, e uma rocha
menor com o formato de urna banqueta. Em um dos cantos, há urna pilha de rochas unidas por uma camada de
lama. Você não consegue imaginar qual é a serventia disso, embora haja três arcas de madeira sobre ela.
Então, você pula de susto quando sua tocha ilumina uma grande criatura, aparentemente também ela
própria feita de rocha, de pé junto a uma porta. Possui aproximadamente uma forma humana, ainda que uni
tanto maior. Seus olhos estão dirigidos diretamente para você, mas você não consegue ter certeza de que ela esteja
de fato vendo você!
Você: Correrá para a outra porta?
Volte para 237
Tentará falar com a criatura?
Vá para 357
Avançará lentamente na direção das caixas no canto?
Volte para 200`, 
  258: `Nenhuma de suas ofertas é particularmente interessante para estas criaturas, que estão muito mais
interessadas em você do que em seus presentes. Você tenta impressiona-las com um Encanto da
Ilusão, criando um arco-íris com todas as cores de lado a lado do aposento. Eles ficam fascinados e
permitem que você passe para a porta do outro lado - volte para 140. Se você não tiver um Encanto
...
nenhum outro Encanto, terá que se aproximar deles — vá para 366.`, 
  259: `Decepcionada, ela olha enquanto você flutua no ar acima dela. Ela gira em torno de si mesma
freneticamente, tentando sugar você para baixo, mas você está fora do alcance dela. Você provoca
com um sorriso e um aceno de mão, depois flutua na direção da Torre Negra, aterrissando lado de
fora da entrada principal. Volte para 218.`, 
  260: `Depois de alguma insistência, a caixa abre. Há uma chave de prata lá dentro. Você:
...
Volte para 237`, 
  261: `O Macaco-Cachorro pede para ver as suas ervas. Por sorte, você tinha apanhado alguns punhados
de ervas no caminho, e você mostra isso a eles. Inclinando a cabeça para um lado, a criatura olha
para você com desconfiança. Pergunta a você então o nome do guarda que você veio tratar — uma
...
Blag
Vá para 394`, 
  262: `Quando você lança o Encanto, um Gark idêntico, armado da mesma maneira, aparece diante de
...
você ou a sua criatura derrotarem o Gark, volte para 180.`, 
  263: `Os Calacorms são criaturas confiáveis e conformadas. São répteis grandes, com pele cinzenta,
caudas longas e duas cabeças, que tagarelam sem parar uma com a outra. Eles não precisam de
muita coisa, tendo poucas ambições na vida além de seus trabalhos, sua comida (eles se alimentam
...
um pavor mortal de ratos, apesar de seu tamanho enorme. Vá para 326.`, 
  264: `Seus grandes músculos se distendem e seguram firmemente o cabo da espada. Você se posiciona e
enfrenta o HOMEM-RINO, pronto para a batalha. Por causa de sua força adicional, você pode jogar
...
Se você vencer, poderá entrar na Torre Negra. Volte para 177.`, 
  265: `Você está em um corredor curto, que termina em uma grande porta de madeira à sua frente. Você
tenta a maçaneta, e a porta abre para um grande aposento. Volte para 169.`, 
  266: `Ele não está interessado na sua conversa ou nas suas histórias, e questiona o seu direito de estar ali.
Sem aviso prévio, ele se transforma em uma Serpente, silvando para você, e desliza pelo chão na
sua direção. Enquanto isso, a Cabeça de Cachorro na parede se desprendeu e está agora flutuando
na sua direção pelo ar. Você usará um Encanto contra eles (vá para 310) ou procurará alguma coisa
em sua mochila para usar (volte para 54)?`, 
  267: `Quando você segura o cálice, o líquido fica verde, e depois marrom sujo, diante de seus olhos.
Cheira a podre, mas você toma um gole. Com uma careta, você cospe tudo - você está bebendo
água lamacenta! Você sai da câmara e se dirige à Cidadela. Volte para 156, mas perde um ponto de
SORTE.`, 
  268: `Quando você golpeia a porta, a madeira racha um pouco, mas não cede. Você tenta de novo, e dessa
...
pur
Ceci`, 
  269: `Os dois homens estão sujos e maltrapilhos. Quando se aproxima, você pode ouvi-los discutindo em
...
Kraken?
Volte para 49`, 
  274: `O armário das armas está trancado, mas pode ser facilmente arrebentado. Lá dentro há várias
espadas e lanças. Você vai arrebentar a fechadura e escolher uma arma (vá para 353) ou procurará
em sua mochila um artefato para usar (vá para 277)?`, 
  275: `Você reconhece o mecanismo como sendo uma Miríade de Bolso, um objeto encantado que pode se
...
HABILIDADE 8
ENERGIA 4
Ou você pode lançar um Encanto. Se você lançar um Encanto da Fraqueza,
a HABILIDADE dele
...
Ilusão, vá para 399. Se você lutar contra ele e vencer, volte para 272.`, 
  276: `Você cai no fundo de um poço profundo — possivelmente um manancial de água tapado. Você se
recompõe e parece estar inteiro. Mas como você vai sair? Cavar apoios para os pés nas paredes do
poço com sua espada levaria um tempo enorme. Você poderia lançar um Encanto da Força para
ajudá-lo nessa tarefa (volte para 165) ou poderia gritar, pedindo ajuda (volte para 202). Qual dessas
possibilidades você escolherá?`, 
  277: `Você sem dúvida recolheu diversos artefatos no seu caminho através da Cidadela. Você tem alguma
...
Se não tiver nenhuma dessas coisas, volte para 119.`, 
  278: `Pedras Mágicas é um jogo um tanto perigoso, mas os Prêmios são altos. Antes do jogo começar, seu
Mestre de Jogos, que é um aprendiz de feiticeiro, lança um encanto sobre uma rocha, que fará com
que ela exploda em algum momento posterior. Os jogadores ficam em círculo e passam a pedra de
um para o outro, percorrendo a roda. Quando a pedra explode, o jogador que a estiver segurando
está fora do jogo - e termina com as mãos bastante machucadas! Os jogadores que permanecem
recebem outra Pedra Mágica para passar de um para o outro, e o jogo continua até que só reste um
jogador. Os espectadores apostam nos jogadores, mas, antes de apostar, eles têm que contribuir com
três Peças de Ouro para o dinheiro do prêmio. Neste jogo, você poderá ganhar trinta e seis Peças de
Ouro, com risco de feriras suas mãos. Tendo escolhido esta opção, você terá que participar do jogo
pelo menos uma vez, mas poderá continuar a jogar por tanto tempo quanto quiser. Se vencer,
poderá tomar posse de trinta e seis Peças de Ouro por cada um dos jogos que participar. Se perder,
terá que deduzir dois pontos de HABILIDADE e quatro pontos de ENERGIA por cada jogo.
Joga-se da seguinte maneira: lance um dado para saber quantos outros jogadores se juntarão a você.
Dê uma letra para cada jogador (A, B, C, etc. - você é o jogador A) e escreva tudo em uma folha de
papel, na forma de um círculo. Depois, jogue outro dado para cada jogador para ver quem começa
...
próximo jogador, que tem que tirar menos de onze. O terceiro jogador tem que obter menos de dez,
e assim por diante. Desloque o seu lápis de letra para letra em volta do círculo para ter controle de
...
Faquinha (vá para 365) ou poderá sair do salão de jogos (volte para 31).`, 
  279: `Você flutua no ar. O aposento continua a sacudir à sua volta, mas você pode voar livremente.
...
Para baixo da mesa?
Vá para 335`, 
  280: `A criatura está atacando você impiedosamente, e não há nada que você possa fazer para evitar isso.
Sua perna está coberta de sangue, e a dor é arrasadora. Você luta com a cabeça que não está vendo,
mas não adianta nada. A criatura salta sobre o seu pescoço, e sua última lembrança, antes de perder
os sentidos, é de suas mandíbulas se fechando sobre a sua garganta. Vá para 323.

nte
“pç
Hi LAMA UA a`, 
  281: `Você abre a porta para outro aposento e surpreende quatro pequenas criaturas sentadas no chão nu.
...
Vá para 356`, 
  282: `Você lança uma pequena bola de fogo diretamente sobre a Cobra de Esgoto, que queima seu corpo,
...
flamejantes, queimando-a fatalmente. Volte para 112.`, 
  283: `Sem magia, o seu destino está selado. Você está fadado a passar o resto dos seus dias como
prisioneiro na Cidadela do Caos.
Você fracassou na sua missão.`, 
  284: `Você lança o Encanto (elimine-o da sua Lista de Encantos) e começa a sair do chão. O tentáculo
não solta, e a dor em sua perna se torna insuportável. Você resolve retornar ao solo antes que a sua
...
lançar um Encanto do Fogo (volte para 114).`, 
  285: `Você diz a eles que não pretende fazer nenhum mal, está apenas prosseguindo em seu caminho.
...
para 23)?`, 
  286: `As pequenas criaturas guincham e se amontoam quando você se aproxima. Você passa todas a fio
de espada, mas eles não oferecem nenhuma resistência! Você fica um pouco desconfiado com essa
batalha tão fácil e dirige-se para a porta do outro lado do aposento. Volte para 140.`, 
  287: `Você oferece o Vidro do Unguento. Alguma coisa invisível arranca-o da sua mão e leva-o na
direção de uma das cabeças de animais. Mãos invisíveis desatarraxam a tampa, e a cabeça fareja o
...
Volte para 25`, 
  288: `As duas criaturas avançam. O Macaco-Cachorro ataca você primeiro, seguido pelo Cachorro-
...
Macaco-Cachorro
VÁ`, 
  289: `O que você tirará de sua mochila?
Um Espelho de Prata?
Vá para 340
...
Se você não tiver nenhuma dessas coisas, vá para 304 e escolha de novo.`, 
  290: `O HOMEM-RINO dá um passo adiante e desfere uma estocada com sua lança na sua direção. Você
...
Volte para 70
Volte para 264`, 
  291: `"O que é isso?” pergunta uma voz fantasmagórica. Você negocia com eles. Você deixará que eles
fiquem com o unguento, se eles deixarem você passar pelo aposento, já que você não está
interessado neles. Uma fantasmagórica mão aparece do nada e tenta arrancar o vidro da sua mão,
mas você o guarda rapidamente. "É de fato o Unguento da Cura”, você ouve uma das vozes dizendo
baixo. "Aceitamos a sua oferta”, diz uma voz. "Deixe o Vidro onde você está e saia do aposento por
...
Ga Cite
e” «My`, 
  292: `O aposento é um elegante quarto de dormir suntuosamente decorado com rendas finas e um tapete
de pele. No centro do aposento, há uma grande cama de quatro colunas. Sentada e recostada na
cama, evidentemente acordada pela agitação toda, está uma linda mulher, com uma aparência de
...
Volte para 42`, 
  293: `Em cima da hora, seu Encanto trava o Tridente em pleno vôo, horrivelmente próximo a seu
pescoço. Ele cai no chão. Vá para 374.`, 
  294: `O Gark se recompõe, abaixa o machado e começa a se desculpar com você por estar dormindo no
posto. Por insistência dele, você concorda em não dizer nada a ninguém. A criatura se oferece para
levar a sua túnica, mas você recusa o oferecimento e segue em frente. Volte para 99.`, 
  295: `Você se concentra e começa a se transformar em um Escorpião Gigante.
O Anão e o Goblin
...
verdadeiro você. O Orca tenta segurar você. Volte para 213.`, 
  296: `A chave gira e a porta abre. Volte para 292.`, 
  297: `Você bate a porta, fechando-a atrás de você, e, juntamente como alarme estridente, você ouve o som
de passos, correndo rapidamente e se aproximando. O corredor à sua frente se bifurca. Você dispara
e segue pelo caminho da esquerda (vá para 316) ou o da direita (volte para 2) - ou prefere retornar
pela porta e chamar o mordomo (volte para 75)?`, 
  298: `Quando suas mãos se fecham em torno do cálice, ele começa a efervescer e espumar, respingando
...
volte para 58 e escolha outra coisa - mas se você estiver determinado, volte para 141.`, 
  299: `A chave não gira, por mais que você tente. Na sua frustração, você atira a caixa no chão - e ela
desaparece! Você procura à sua volta pela caixa invisível, mas não consegue achá-la em lugar
nenhum. Em desespero total, você se vira na direção da porta e parte mais uma vez para a sua meta.
Volte para 237.`, 
  300: `Jogue um dado. Se você tirar um, dois ou três, então este número de facas atinge você (cada faca
...
para 244), seja desembainhando a sua espada (vá para 346).`, 
  301: `Você sente a força se espalhando pelo seu corpo. Você tenta lutar com a cabeça desta criatura, mas
sua própria força parece ter também crescido e se igualado à sua. Sua perna está agora inútil e
coberta de sangue. Sua força começa a se esvair e, quando isso acontece, as mandíbulas da criatura
se fecham sobre a sua garganta. A consciência vai sumindo. Vá para 323.`, 
  302: `Elas ordenam que você leve uma bandeja de comida por uma porta na parede do outro lado para o
Grande Salão e a deixe na mesa, pois os Ganjees logo estarão lá para ceia. Elas também advertem
...
experimenta a maçaneta e ela gira. Volte para 169.`, 
  303: `O Golem avança, e você o golpeia com sua espada, mas ela atinge uma rocha sólida e retine
ruidosamente.
Você terá que resolver esta batalha e deduzir um ponto de HABILIDADE durante a
luta:
GOLEM
HABILIDADE 8
ENERGIA 10
Se você derrotar a criatura, volte para 147.`, 
  304: `A porta se abre, e você penetra no aposento. É bastante grande e está decorado com vários entalhes.
Parece ser alguma coisa como o estúdio de um artista, e há diversas estátuas inacabadas de pedra
alinhadas na parede. No centro do aposento, há um grande GÁRGULA de pedra sobre uma caixa
...
Volte para 64`, 
  305: `Você joga o Vidro no Gárgula. Ele se parte, mas não causa nenhum dano. À criatura dá um soco em
você que o atinge no peito, jogando você no chão. Você perde dois pontos de ENERGIA. E melhor
você sair deste aposento rapidamente e seguir pela sacada para a porta do meio. Volte para 64.`, 
  306: `À uma pequena distância, há uma porta que bloqueia a passagem. Na realidade, é apenas uma meia-
porta, e chega só até a cintura em você. Um letreiro na porta aponta para adiante e diz "Somente
Jogadores". Você vai empurrar e abrir esta porta (volte para 52) ou voltará e entrará no aposento da
porta ornamentada (volte para 132)?`, 
  307: `Quando você lança o Encanto, a criatura avança sobre você e fere seu braço coma lança. Você
...
Se você o derrotar, poderá entrar na Cidadela. Volte para 177.`, 
  308: `A maçaneta gira e você entra em um cômodo às escuras. Volte para 257.`, 
  309: `Vocês dois revistam os bolsos do homem alto. Você encontra vinte Peças de Ouro, as quais vocês
...
Se você não possuir nenhum desses, retorne para 104 e escolha de novo.`, 
  312: `Você segura o seu Espelho no alto. Isso parece ter pouco efeito sobre a criatura, que continua a
...
decidir o que fazer em seguida. Volte para 184.`, 
  313: `A fruta é doce e suculenta. Você come uma, depois outra - o sabor é delicioso! Você ganha dois
pontos de ENERGIA. Mas, para sua surpresa, quando você tenta limpar a garganta depois, nenhum
som sai da sua boca. Você comeu uma Fruta do Silêncio. Seu efeito peculiar é apenas temporário,
...
magia (da próxima vez que for dada uma opção de Encantos), mas, depois disso, voltará ao normal.
...
você acabou de usar para entrar (volte para 281).`, 
  314: `Você tenta se concentrar, criando a ilusão de que o feiticeiro está igualmente em um aposento que
sacode. O Encanto é lançado (e você tem que eliminá-lo de sua lista), mas não faz efeito; você não
consegue se concentrar totalmente. Balthus Dire está quase em cima de você. Vá para 373.`, 
  315: `Balthus Dire cai em um estado de concentração, enquanto você brinca com a sua Miríade de Bolso.
...
lutar com ela! Você se volta para enfrentar o feiticeiro, que está se concentrando em um Encanto há
algum tempo. Volte para 191.`, 
  316: `As passadas que você ouviu - que realmente deveriam ser chamadas de "mãozadas" — pertencem a
três GIRAS, que agora rolam descendo a passagem na sua direção, o que faz com que você recue de
volta para a porta. Estas criaturas são animais peculiares que têm, ao invés de pernas, um segundo
par de mãos. Eles se deslocam dando cambalhotas a um ritmo bem acelerado. Suas cabeças - ou
pelo menos seus rostos - estão colocados no centro do peito. Embora não sejam muito prático como
espadachins, tendo em vista seus meios de movimentação inadequados, são excelentes lançadores
de facas. Pegando facas em seus cintos enquanto se movimentam em círculos, eles podem dispará-
...
139. Se não tiver, volte para 300.`, 
  317: `Os quadros são retratos de vários Senhores e Condes de destaque no Reino da Rocha Escarpada.
Atrás de uma cadeira, na cabeceira da mesa, há um retrato do próprio Balthus Dire. Ele realmente
aparenta ser um adversário poderoso. Acrescente um ponto de SORTE pela advertência da sua
aparência, mas você terá que perder um ponto de ENERGIA pelo medo que ele inspira. Você pode
agora continuar pela escadaria do lado esquerdo (volte para 19), ou pela escadaria do lado direito
(volte para 197).`, 
  318: `O feiticeiro está demonstrando sinais de exaustão mental e reage com lentidão quando você pára
atrás dele. Você nota que ele está usando um anel de ouro com um grande rubi incrustado no dedo
...
artefato para usar (volte para 277).`, 
  319: `Você se concentra no seu braço. Ele começa a endurecer e adquire a cor metálica e fosca do ferro.
...
eliminar o Encanto da Ilusão. A sua ilusão evidentemente foi pouco convincente. Você lança mão
da sua espada. Vá para 333.`, 
  320: `Você se concentra fortemente, mas, por mais que tente, não consegue interceptar nenhum dos
pensamentos de Balthus Dire - ele está bloqueando o seu Encanto! Você pode continuar com um
Encanto da Ilusão (vá para 332), um Encanto da Fraqueza (volte para 113) ou pode desembainhar a
sua espada para atacá-lo (vá para 351).`, 
  321: `Cautelosamente, e mantendo-se fora da área visível, você se esgueira pelas bordas do pátio na
...
abordará os dois embaixo da tocha (volte para 269) ou o grupo em volta da fogueira (vá para 339)?`, 
  322: `O que você vai tirar de sua mochila?
Uma Aranha em um Vidro?
Volte para 39
...
para 248).`, 
  323: `Você desperta e olha em torno de si. A medida que sua memória volta, você fica admirado de estar
vendo. A sua perna está sensível, mas não há ferimento! Você ouve um risinho frouxo vindo de um
lugar acima de você e subitamente a coisa toda faz sentido...
Autuando acima de você está O'Seamus, agora rindo alto. A coisa toda foi uma grande brincadeira!
...
dá um risinho, depois mais uma risada, e acaba rindo alto. Por algum tempo, vocês dois se acabam
...
movimento da mão, ele faz com que apareçam uma espada e um prato na mesa. A espada é uma
...
qualidade. Você pode levar essas coisas com você, mas terá que deixar a sua espada velha para trás.
...
TA
PARTA TP`, 
  324: `"Você não pode se esconder de mim!" ele grita. Isso é de fato verdade, e você toma consciência de
que poderia estar em perigo, uma vez que você não consegue vê-lo. Vá para 369.`, 
  325: `A criatura é um tanto volumosa e desajeitada, e fica bufando furiosamente enquanto você se esquiva
de seus golpes. Você desembainha a sua espada e luta:
HOMEM-RINO
HABILIDADE 8
ENERGIA 9
Se você derrotá-la, poderá entrar na Cidadela. Volte para 177.`, 
  326: `Você recoloca o livro no lugar. Você continuará folheando livros (volte para 84) ou sairá pela porta
do outro lado, atrás do bibliotecário (volte para 31)?`, 
  327: `Eles pegam
a sua Miríade de Bolso e brincam com ela alegremente. Enquanto eles estão
...
366. Risque seu presente da sua Lista de Equipamentos.`, 
  328: `Você fecha a porta atrás de você e chega ao pé de outra escadaria, que sobe em espirais para o
...
anteriores! Suas seis cabeças de serpente atacam você com seus dentes aguçados e cruéis. Você fica
...
Volte para 226`, 
  329: `Você se concentra na mente dela e fica chocada ao descobrir que ela não está viva, como parece,
mas que já morreu há muitos anos. Desde que um incêndio violento - uma maldição lançada sobre
ela por Balthus Dire em pessoa, por ela não ter cumprido as ordens de lavar suas vestes a tempo
para uma reunião importante - matou-a e às suas crianças, seu corpo espectral foi condenado a lavar
...
caminho (volte para 221)?`, 
  330: `O feiticeiro grita de pavor quando você exibe o Vidro. Sentindo que esta pequena criatura pode ser
um aliado valioso, você abre o Vidro e a solta. A expressão do feiticeiro se transforma em um
sorriso dissimulado e, enquanto você observa, o pequeno Homem-Aranha avança, não na direção de
...
ferimentos, volte para 119.`, 
  331: `Os dentes afiados do Peixe Abocanhador cravam-se no seu rosto e nariz, quando você tenta se
esquivar. Você perde um ponto de HABILIDADE e três pontos de ENERGIA enquanto trata da sua
...
insultam e provocam você. Volte para 265.`, 
  332: `O queixo de Balthus Dire cai quando acontece uma transformação diante dos olhos dele. Seu corpo
...
FOGO, e você agarra o Tridente que está no chão para servir de arma para você. O feiticeiro foge
de você horrorizado. Você pode saltar por sobre a mesa para atacá-lo (volte para 80) ou exigir que
ele cancele seus planos de conquista e se renda a você (volte para 48).`, 
  333: `Você desembainha a sua espada e se prepara para cortá-lo em pedaços. Ele levanta os olhos para
você com uma expressão que faz com que acredite que ele não está completamente no controle das
suas ações. Com pena, você bate na cabeça dele com o cabo da espada, fazendo com que ele uive e
...
pontos de ENERGIA pelo dano que ele causou ao seu braço e segue adiante. Volte para 14.`, 
  334: `Você toma dois goles. Não é ruim! Você enche a boca, mas, ao fazê-lo, fica imaginando porque o
Elfo está rindo. De repente, ele pergunta se você é realmente um convidado. Embora sua mente
esteja confirmando que você é de fato um convidado, sua voz está dizendo que não é, que você veio
para pôr um fim nos planos de conquista de Balthus Dire! Você pragueja ao compreender que o
vinho deve conter uma dose de Soro da Verdade. O Elfo Negro agora sabe da sua missão e deve ser
impedido de dizer a outros. Você desembainha a sua espada e, ao fazê-lo, ele puxa um pequeno
mecanismo metálico da bolsa presa em volta da cintura dele. Com um toque, isso se transforma em
uma arma de lâmina em serra. Volte para 275.`, 
  335: `Há uma gaveta secreta fixada sob a mesa, levemente aberta, e, aparecendo fora da gaveta, há um
rolo de pergaminho. Você pega o rolo e enfia em sua túnica. Mas você pode ouvir Balthus
murmurando bem baixo. Um Encanto! Mas o que será agora? E o que você pode fazer? De repente,
...
mesa reage com um ruído de rachadura. Vá para 342.`, 
  336: `Resolva sua batalha com a criatura:
GARK
HABILIDADE 7
ENERGIA 11
Depois de quatro Séries de Ataque, você poderá Fugir por uma das portas do outro lado do aposento
(volte para 99), ou então poderá continuar e lutar até a morte. Se ficar e vencer, volte para 180.`, 
  337: `O feiticeiro é de fato tão bom espadachim quanto mágico. Resolva sua batalha:
BALTHUSDIRE
HABILIDADE 12
ENERGIA 19
...
para 400.`, 
  338: `A porta abre para uma passagem. Você segue a passagem sempre em frente por algum tempo,
...
adiante direto. Finalmente, o caminho acaba se alargando. Volte para 90.`, 
  339: `Há um time eclético sentado em volta do fogo. Um Orca como rosto coberto de verrugas está
distribuindo magros bocados de carne mal passada para os outros. Um Anão de pele verde rosna e
reclama do tamanho de seu pedaço, enquanto dois Goblins - homem e mulher - estão se acariciando.
Eles riem e se sacodem, e de vez em quando ela dá um tapa na cara feia do macho, causando ainda
mais risos. Quando você se aproxima, eles param e olham para você com rostos pouco amigáveis.
Olham com desprezo para a sua aparência asseada, e a Goblin fêmea cochicha algum comentário
...
Volte para 149`, 
  340: `Você segura o espelho no alto, mas a criatura simplesmente desfere um golpe contra ele,
despedaçando-o no chão. E melhor você sair desse aposento rápido e tentar a porta do meio da
sacada. Volte para 64.`, 
  341: `Você lança o Encanto em torno de si mesmo e avança. Quatro ou cinco flechas voam na sua
direção, mas param no ar a um metro de distância antes de atingir você, caindo inofensivamente ao
chão. Você chega até o monumento. Lembre-se de eliminar o Encanto do Escudo da sua lista. Volte
para 209.`, 
  342: `O feiticeiro afasta-se da mesa e ri. "Agora você está em minhas mãos, camponês!" ele exulta.
Cautelosamente, você sai de debaixo da mesa. Isto é, você tenta sair. Mas você não consegue passar
do limite das bordas da mesa. Ele criou paredes invisíveis que agora prendem você embaixo da
mesa! Por mais que você tente, não consegue romper estas barreiras. Você agora é prisioneiro dele.
...
na direção da porta do outro lado do aposento. Volte para 140.`, 
  346: `Quando os Giras vêem você desembainhar a sua espada, param e tagarelam com muita agitação.
...
ENERGIA
Primeiro GIRA`, 
  347: `A Górgona olha para o espelho e grita. Você arrisca dar uma olhada na criatura, seus olhos subindo
a partir dos pés. Mas a Górgona desapareceu, e em seu lugar está Balthus Dire, mais uma vez diante
de você. Volte para 12.`, 
  348: `"Oh, eu não iria nesta direção”, diz O'Seamus. "Não é uma região agradável." Estas três portas são
o único caminho para seguir adiante. Duas delas são muito perigosas, e a terceira tem um cheiro
muito forte. No lado oposto do aposento, há três portas. Uma tem uma maçaneta de latão, outra tem
...
Volte para 68`, 
  349: `Uma réplica de Balthus Dire se materializa na sua frente. O próprio Dire levanta uma sobrancelha.
“Ataque!” você ordena ao sósia, que se volta para o centro do aposento e avança. A dois metros do
feiticeiro, ele pára e segura a cabeça com as mãos, atordoado, vira-se e vem na sua direção! O
feiticeiro ri. “Este jogo pode ter dois participantes!” diz Dire. Você se concentra, e a réplica recebe
suas ordens de retornar na direção de Dire. O sósia acaba por interromper a sua aproximação e age
conforme as suas ordens. Isso continua por algum tempo, e você compreende que vocês dois têm o
...
desaparecendo. A concentração foi de certa forma exaustiva para você. Você levanta os olhos e vê
Balthus Dire erguer as mãos para o teto e depois deixá-las cair com força sobre a mesa. Que magia
ele estará usando agora? Volte para 157.`, 
  350: `Você tenta um estratagema simples para se livrar dela, na esperança de que ela não seja muito
inteligente. Olhando na direção das sombras,você afirma estar vendo uma oura criatura semelhante.
...
que você corra para a entrada da Cidadela. Volte para 218.`, 
  351: `Quando você avança com sua espada desembainhada, o feiticeiro puxa uma cimitarra do seu cinto.
...
Se você matar o feiticeiro, vá para 400.`, 
  352: `Você entra no aposento na ponta dos pés. Está escuro lá dentro, e o ar está úmido. Há um poste de
madeira rústica pregado em uma das paredes, com diversos ganchos nele. Há duas portas na parede
...
usava como travesseiro, e rapidamente retira a bainha de couro, revelando uma afiada cabeça de
...
já está com.ela na mão. "Assim seja," ele diz, tirando uma cimitarra
...
Se você vencer, vá para 400.`, 
  354: `Você abre a porta e entra em outro aposento, feliz por ter deixado para trás a aborrecida criaturinha.
Volte para 188.`, 
  355: `Se você não quiser (ou não puder) usar a sua magia, terá que confiar na sua espada. Desembainhe a
sua espada e volte para 351.`, 
  356: `Eles ficam um tanto aliviados por saber que você não tem intenção de fazer mal a eles e voltam a
sentar-se no chão, convidando você para se juntar a eles. O aposento é pequeno e simples, com
folhagens espalhadas pelas paredes, possivelmente com o intuito de servir de decoração, embora as
folhas estejam agora murchas e há muito tempo mortas. Um pequeno fogo arde em um dos cantos,
embaixo de um orifício no teto. Há duas portas na parede de fronte a você; uma à esquerda, a outra
...
resolve não se arriscar a dizer muito sobre a sua missão, mas faz perguntas genéricas sobre o lugar.
...
oferecem também a você o direito de receber deles um favor antes de ir embora, pois eles também
...
alto e aperta mais. Ele diz a você que reconsidere, do contrário será morte certa. Você continuará a
...
concordará em se submeter ao comando dele (volte para 256)?`, 
  359: `Você tenta se esquivar, mas não consegue evitar o impacto em cheio do projétil, que atinge você na
testa e se derrama por toda a sua cara. Você fica imóvel, esperando talvez pelo início de algum tipo
de reação ácida, mas o líquido pastoso simplesmente pinga do seu rosto no chão. Cautelosamente,
você o toca, primeiro com o dedo, depois com a língua. Você acaba de ser atingido por um tomate
maduro! Mais uma vez, você se volta para enfrentar a figura adormecida. Volte para 29.`, 
  360: `Você lança outro Encanto. Sua Hidra parcialmente formada cresce um pouco mais, mas ainda não
está completa. Você precisará de mais um Encanto de Cópia de Criatura para formar a criatura
inteira. Se você quiser lançar este terceiro Encanto, faça isso e deixe as Hidras lutarem até a morte.
HIDRA
HABILIDADE 10
ENERGIA 17
Se a sua criação vencer, volte para 229. Se a sua criatura perder, ou se você não possuir Encantos
suficientes para completar a criação, você terá que decidir o que fazer em seguida (volte para 184).`, 
  361: `A porta abre novamente mas, quando você faz isso, ouve o ruído ensurdecedor de uma campainha
de alarme! Teste a sua Sorte. Se você tiver sorte, volte para 297. Se você não tiver sorte, volte para`, 
  362: `A porta abre, e o pequeno aposento no interior é iluminado a luz de vela. Cautelosamente, você olha
lá para dentro e vê uma cena estranha. Sobre um altar de pedra no meio do aposento, há três cálices
...
chilreando excitadamente. De vez em quando, uma delas pousa no altar e toma um gole do líquido
leitoso. A porta aberta range nas dobradiças e assusta os seres. Eles dão uma volta para olhar para
...
rapidamente e prosseguir na direção da Cidadela (volte para 156).`, 
  363: `Há três portas ao longo da sacada. Você experimentará:
A porta da esquerda?
Volte para 228
A porta do centro?
Volte para 64
A porta da direita?
Volte para 304`, 
  364: `Quando seu Encanto faz efeito, você vê um pequeno camundongo correr na direção da mesa. Você
pragueja ao compreender que o Encanto pode não ter funcionado devidamente. Mas você volta a ter
...
berra, dizendo que você dará sumiço no rato para ele, se ele libertar você. Ele concorda rapidamente
...
camundongo desaparece. Volte para 174.`, 
  365: `Você escolheu um jogo de azar mortal que é proibido por lei na maioria dos reinos. Uma vez que
você escolheu jogar, terá que participar de pelo menos um jogo, mas poderá continuar, se quiser.
Seu Mestre de Jogos é um aprendiz de feiticeiro e selecionou uma variedade de prêmios para você.
...
outras cinco possuem lâminas de mola, que não lhe causarão nenhum mal. Você está jogando contra
uma das criaturas no salão e somente um de você dois sobreviverá. Cada um na sua vez, vocês terão
...
jogo continua até que um de vocês selecione o punhal verdadeiro e se esfaqueie no coração, e assim
o sobrevivente poderá se apossar do prêmio. Seu adversário escolherá primeiro.
Jogue um dado para
ele. Depois, faça o mesmo para você. Quando um de vocês obtiver um seis, a verdadeira adaga foi
...
Jogado, você pode jogar Escolha de Seis (volte para 171), Pedras Mágicas (volte para 278) ou dizer
adeus a seus "amigos" e sair do salão (volte para 31).`, 
  366: `Quando você passa pelas pequenas criaturas, elas ficam olhando para você silenciosamente. Elas
parecem simplesmente achar que você é interessante. Você sente que alguma coisa não vai bem por
aqui. Volte para 140.`, 
  367: `Alguma distância adiante na passagem, você chega a uma junção de quatro caminhos. Você toma o
caminho do norte, que acaba chegando a urna grande porta de madeira. Você não consegue ouvir
...
para 308) ou derrubá-la à força (volte para 121)?`, 
  368: `Você revista os dois bolsos deles e acha vinte e oito Peças de Ouro, que leva consigo. Quando você
está prestes a prosseguir, lembra-se do punhal - a fonte da desavença - e o apanha. Volte para 15.`, 
  369: `Você tem que ver o que ele está fazendo. Quando você tenta espiar por trás da cortina, sente que ela
se enrola em torno de você, como se houvesse vento - mas não há. A cortina está se apertando em
volta de você. Você luta, mas o pano pesado está envolvendo você. Está em torno da sua garganta e
...
batalha será dele. Mas não há nada que você possa fazer. Seu mundo fica escuro... Você falhou na
sua missão.`, 
  370: `A caixa é solidamente construída, e você não consegue arrebentar a fechadura com as mãos. Você
desembainha a sua espada para tentar quebrá-la a golpes de lâmina e, ao fazer isso, a caixa cai sobre
...
Volte para 237`, 
  371: `A criatura grunhe e abre a porta para deixar você entrar. Volte para 177.`, 
  372: `Ao lançar seu Encanto do Escudo, uma garrafa ainda atinge você no ombro. Você não sente nada.
Alguma coisa não está muito certa, e você tenta cancelar o Encanto. Infelizmente, ele já foi lançado,
e você pode ver as garrafas se quebrando de encontro a seu escudo mágico. A garrafa que acabou de
...
para 95.`, 
  373: `Balthus Dire se ajoelha a seu lado. Ele agarra seus pulsos com uma das mãos, e você pode sentir sua
...
vergonha permitir que tamanho talento seja desperdiçado. Posso matar você agora ou oferecer uma
...
Volte para 358`, 
  374: `Enquanto se recompõe, depois do susto, você olha em torno do aposento. Trata-se obviamente de
...
formas. No centro do aposento, há uma maquete de uma paisagem que você reconhece como sendo
o Vale dos Salgueiros. Exércitos de tropas em miniatura estão posicionados na maquete. Este deve
ser o plano de invasão!
Recostado na mesa, com os olhos fixos em você, está o próprio Balthus Dire! Sua estatura em si já é
...
guarnecidas de pregos, ele tem mais a aparência de um soldado do que do feiticeiro que realmente
é.
“Camponês insolente!” ele rosna. “Você acha que pode medir forças com Balthus Dire?” Com estas
...
terminado em um gancho de terrível aparência. Ao se aproximar, vem golpeando o ar à sua frente.
“Ora, acho que você não é adversário nem mesmo para uma FERA DAS GARRAS!” ri Dire.Você:
...
Volte para 158`, 
  375: `Ele indica um livro na prateleira que é uma lista alfabética de todos os tipos de criaturas. Você
...
Ganjees?
Volte para 63`, 
  376: `Você lança seu Encanto do Escudo. Que lástima, este Encanto não faz efeito contra armas mágicas!
...
dor, você tomba no chão. A cortina da morte cai sobre você. Você falhou na sua missão.`, 
  377: `Você se controla e se concentra. Qual será o seu próximo ataque?
Um Encanto da Ilusão?
Volte para 332
Um Encanto da Fraqueza?
Volte para 113
...
Nenhum desses?
Volte para 355`, 
  378: `Você dá alguns passos adiante, e uma outra flecha erra por pouco o seu pé. Mais uns poucos passos
e uma flecha rasga a sua túnica, arranhando o seu antebraço. Você ainda não consegue ver ninguém,
nem ver de onde as flechas estão vindo. Depois de mais alguns passos, surge mais uma flecha, mas
esta rasga a sua perna. Você grita alto - e terá que descontar quatro pontos de ENERGIA - mas você
Já está quase no monumento, que servirá de proteção para você. Você salta para frente e se esconde
atrás dele até que as flechas parem de vir. Volte para 209.`, 
  379: `Você solta a corda e flutua no ar. Pousando de volta no chão, na borda do fosso, você xinga a
armadilha demoníaca preparada para aventureiros gananciosos como você. Você segue até a porta
oposta à da sua entrada e experimenta a maçaneta. Volte para 206.`, 
  380: `Quando você senta, eles se levantam. O Anão pega uma clava e salta sobre você, enquanto o Goblin
e o Orca apanham espadas. A namorada do Goblin dá um grito e sai do caminho, retirando-se para a
escuridão. Volte para 213.`, 
  381: `Teste a sua Sorte. Se você tiver sorte, o anel desliza para fora do dedo dele, e você agora o tem em
...
Balthus Dire entre em ação e se volte contra você com sua espada. Volte para 337.`, 
  382: `Eles correm pelo aposento em pânico, esbarrando uns nos outros e gritando: "Ai, meu Deus, ai,
minha nossa, este estranho parece malvado, onde estão as nossas armas?" Você ri da desordem
deles e guarda a sua espada. Eles se acalmam e ficam olhando para você. Você pode seguir adiante
(volte para 285) ou conversar com eles (volte para 356).`, 
  383: `A força do velho começa a retornar à medida em que o Encanto da Energia vai fazendo efeito
(desconte este Encanto dos seus Encantos). Ele conta para você que foi espancado na cabeça por
cruéis Ganjees, que têm prazer em fazer maldades. Você conduz a conversa no sentido da Cidadela
propriamente dita. De repente, sem nenhuma razão visível, uma pontada de dor o atinge por dentro.
...
espada (volte para 333) ou usará um Encanto Mágico para se libertar (volte para 189)?`, 
  384: `Você brinca com o mecanismo e, subitamente, uma linha longa e fina se desenrola da haste. Você
...
volte para 252. Se obtiver um, dois, três ou quatro, volte para 107.`, 
  385: `Eles dão tapinhas nas suas costas e boas-vindas. Uma criatura magra, de pele escura, põe uma
caneca de aguardente na sua mão. Você bebe o oferecido de uma só vez. Outra caneca vem.
Acrescente dois pontos de ENERGIA, uma vez que a bebida é bastante reconfortante. Em seguida,
...
Escolha de Seis?
Volte para 171`, 
  386: `Do lado de fora da porta, a passagem continua em declive, e você a segue por algum tempo. Você
...
atravessará o esgoto (volte para 204) ou tentará agarrar a corda e se valer dela para passar para o
outro lado (volte para 108)?`, 
  387: `À simples menção de um Espelho de Prata, ela se levanta, ergue as mãos e ordena a seus Fantasmas
que parem. Você dá a ela o Espelho, e ela diz que você pode seguir o seu caminho. Você tem sorte
de estar vivo. Volte para 6.`, 
  388: `Todo o seu corpo se tensiona com o esforço. Alguns momentos depois, ele recupera a compostura e
mais uma vez olha para você. "Fraqueza!" ele ironiza, "Certamente você não achava que poderia me
...
se prepara para desferir um contra-ataque. Volte para 157.`, 
  389: `Quando você se aproxima do espeto, uma das velhas joga um pó no fogo, e as três se afastam,
dando risadas. Você está em guarda. Você observa o fogo começando a rugir, e as chamas
crescendo ameaçadoramente. Subitamente, várias das labaredas saltam do fogo e tomam a forma de
...
Prepara um Encanto?
Volte para 311`, 
  390: `Ele começa a atormentar você, derrubando-o com uma lufada de vento a cada vez que você se
levanta. Teste a sua Sorte. Se você tiver sorte, volte para 350. Se não tiver sorte, volte para 122.`, 
  391: `O Gark pega as suas três Peças de Ouro, coloca-as em uma bolsa presa em volta da cintura e mostra
...
(porta da direita) ou para o Salão de Jogos (porta da esquerda). Volte para 99.`, 
  392: `A chave gira, e a porta se abre. Volte para 196.`, 
  393: `Você lança o seu Encanto e se concentra nas três criaturas em transformação. As imagens passam à
...
estão nem um pouco preocupados com a sua presença - mais provavelmente eles vêem você como
um divertimento. Com bastante frequência, porém, eles pensam em ouro, e suas emoções indicam
uma grande ganância. Talvez este seja o seu passaporte para a segurança. Se você tiver Peças de
Ouro, volte para 27. Se você não tiver ouro, é melhor você sair do aposento rapidamente e tentar a
outra porta. Volte para 25.`, 
  394: `As criaturas se entreolham, como se o nome não lhes fosse estranho, mas elas não pudessem
lembrar exatamente de onde o conheciam. Você rapidamente acrescenta que ele está na turma do
primeiro andar. Eles dão de ombros e acabam por decidir que você deve estar dizendo a verdade. O
Macaco-Cachorro chama o porteiro, que finalmente aparece para deixar você entrar. Volte para 251.`, 
  395: `Você lança o Encanto e se concentra, criando uma ilusão de que você é um poderoso feiticeiro e
que está começando a se cansar das gozações deles. Mas nada acontece! Mais uma vez, um riso de
...
procurará em sua mochila alguma coisa para usar (volte para 322) ou desembainhará a sua espada
(volte para 248)? Se você não tiver tentado ainda um Encanto do Fogo sobre eles, poderá fazer isso
(volte para 85).`, 
  397: `Não é uma refeição muito farta, mas você estava com fome e com sede, e esta oferta repõe dois
...
Encanto para tentar sair desta situação (volte para 193).`, 
  398: `Você lança o encanto, e sua força retorna, permitindo que você acabe de subir os degraus. Quando
...
muralha na direção da Torre Negra. Volte para 79.`, 
  399: `Você lança o Encanto. O Elfo se aproxima e, ao fazê-lo, a Miríade de Bolso desaparece da sua mão!
...
Se você vencer, volte para 272`, 
  400: `Balthus Dire, caído a seus pés, está morto. Sua missão foi cumprida! O Vale dos Salgueiros está
livre de ataques - por enquanto, pelo menos.

A CIDADELA DO CAOS
Parte história, parte jogo, neste livro VOCÊ se torna o herói!
A Cidadela do Caos guarda perigos sombrios e fatais
para qualquer um que seja temerário o bastante para se
arriscar a cruzar seus horripilantes portões. Porém, você
terá que se arriscar mesmo assim, pois sua missão está no
coração da Cidadela, com o terrível feiticeiro, Balthus
Dire.
Dois dados, um lápis e uma borracha são tudo que você
precisa para sua jornada. VOCE decide que caminho
seguir, que monstros enfrentar e onde usar seus conheci-
mentos especiais da arte da magia.
LIVROS-JOGOS AVENTURAS FANTÁSTICAS
Uma sensação no mundo inteiro!
Ilustração de capa por
IAN MILLER
EDITORA
MARQUES SARAIVA

Este livro foi trazido à você por Oculum Malum.
Este é um material de distribuição de fãs para fãs destes livros e seus direitos autorais de publicação
no Brasil, pertencem à Editora Marques Saraiva.
Copyright O by Marques Saraiva Gráficos e Editores
Este e-book se destina única e exclusivamente a quem possui o livro original e tem o objetivo de
preservar o livro da ação do tempo e do manuseio do mesmo.
Se você adquiriu este material e não possui o livro original, delete-o imediatamente de seu
computador pois caracterizar-se-á crime de pirataria.
É proibida a comercialização deste material.
Visite: http://www .orkut.com/Community.aspx?emm=32247471
http://aventuras-fantasticas.blogspot.com/
Dúvidas, sugestões ou reclamações? Mande um e-mail para oculum.malum O gmail.com`, 
};